...
- candidate result pack: `outputs/reports/historical_candidate_packs/resume_gate/resume_gate.json`
...
| candidate_name | `PASS` | candidate name is `resume_gate` |
...
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/resume_gate/artifacts/candidate_metrics.json` hash matches `3292f59291aade8cfb4d3c8183029c24a58b81841ae75d90ef7911f2fb7e547f` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/resume_gate/artifacts/candidate_summary.md` hash matches `361868ed2e2684e25997e3ea81b444fff75c8c51c890e165f9a10379407f4dc2` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/resume_gate/artifacts/combined_report.csv` hash matches `fe90ab291deac9322e605cf1b892f6e6c1703fe47d72914c35c85881c7c3007f` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/resume_gate/artifacts/combined_report.md` hash matches `2416275f166cebf439caa08e03752bcf96d29e2e8f497224d50db8ca7cf2e26c` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/resume_gate/artifacts/retry_block_report.csv` hash matches `bbbdbe8eabf869147eec640576077f6cc82195e86b7f325fb250974ea7e00a81` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/resume_gate/artifacts/retry_block_report.md` hash matches `d25812a1a7def541375e2900758e24f92a1aac4b2cd54d0e1621f46cb9ae8574` |
