...
- candidate result pack: `outputs/reports/historical_candidate_packs/claim_broadening/claim_broadening.json`
...
| candidate_name | `PASS` | candidate name is `claim_broadening` |
...
| actual_sets.combined | `FAIL` | candidate combined lane/seed set `[('fresh', 23), ('fresh', 29), ('fresh', 31), ('fresh_extra', 37), ('fresh_extra', 41), ('fresh_extra', 43), ('original', 7), ('original', 11), ('original', 19)]` does not match frozen `[('fresh', 23), ('fresh', 29), ('fresh', 31), ('fresh_extra', 37), ('fresh_extra', 41), ('fresh_extra', 43), ('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59), ('original', 7), ('original', 11), ('original', 19)]` |
| actual_sets.retry_block | `FAIL` | candidate retry-block lane/seed set `[('fresh_extra', 37), ('fresh_extra', 41), ('fresh_extra', 43)]` does not match frozen `[('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59)]` |
| artifacts.duplicates | `PASS` | artifact roles are unique |
| artifacts | `PASS` | candidate pack exposes all required artifact roles |
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/candidate_metrics.json` hash matches `63ef32aac0ccc2d754e53d6e4b8f41ec51ef76e9f865405a4c0686a619a67584` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/candidate_summary.md` hash matches `65f573c473bbeb8dd35b112f271dc64f2f6f46e7bb0da1bc999d288a8411209b` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/combined_report.csv` hash matches `601441265bddebbe7608cd07f99e903926fa4a7d3bda147dfbe1b7bcacb620f0` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/combined_report.md` hash matches `2d652120b9e31ae444f6d01abeffa50adae7451da265c16264599e6b0b115b4a` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/retry_block_report.csv` hash matches `d7e2c9dfaca7912fbd06eecb17e33cfab86cb20cb8c2da42cc1754c1af945a54` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/retry_block_report.md` hash matches `ae595beb5dc0169cadf0c83dc79d49b1c438845b97c5aeb16cecc47aea9137d9` |
...
| candidate_pack::candidate_name | `PASS` | candidate name is `claim_broadening` |
...
| candidate_pack::actual_sets.retry_block | `INCONCLUSIVE` | candidate retry-block lane/seed set `[('fresh_extra', 37), ('fresh_extra', 41), ('fresh_extra', 43)]` does not match frozen `[('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59)]` |
...
| candidate_pack::artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/candidate_metrics.json` hash matches `63ef32aac0ccc2d754e53d6e4b8f41ec51ef76e9f865405a4c0686a619a67584` |
| candidate_pack::artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/candidate_summary.md` hash matches `65f573c473bbeb8dd35b112f271dc64f2f6f46e7bb0da1bc999d288a8411209b` |
| candidate_pack::artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/combined_report.csv` hash matches `601441265bddebbe7608cd07f99e903926fa4a7d3bda147dfbe1b7bcacb620f0` |
| candidate_pack::artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/combined_report.md` hash matches `2d652120b9e31ae444f6d01abeffa50adae7451da265c16264599e6b0b115b4a` |
| candidate_pack::artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/retry_block_report.csv` hash matches `d7e2c9dfaca7912fbd06eecb17e33cfab86cb20cb8c2da42cc1754c1af945a54` |
| candidate_pack::artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_broadening/artifacts/retry_block_report.md` hash matches `ae595beb5dc0169cadf0c83dc79d49b1c438845b97c5aeb16cecc47aea9137d9` |
...
| claim_scope | `FAIL` | candidate requests disallowed widening: `specifically_multi_expert_routed_advantage` |
