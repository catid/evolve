...
- candidate result pack: `outputs/reports/historical_candidate_packs/final_frozen_state/final_frozen_state.json`
...
| candidate_name | `PASS` | candidate name is `final_frozen_state` |
...
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/final_frozen_state/artifacts/candidate_metrics.json` hash matches `146cba09cbd6c144c2cc337ded8e2c9e7df9883135cab9e6493f690005f6d89b` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/final_frozen_state/artifacts/candidate_summary.md` hash matches `b06d8fa0289f71dea1032c72f268d95600928e0d239b08c6ff5f9107e60d915a` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/final_frozen_state/artifacts/combined_report.csv` hash matches `fe90ab291deac9322e605cf1b892f6e6c1703fe47d72914c35c85881c7c3007f` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/final_frozen_state/artifacts/combined_report.md` hash matches `34aeb1880b4433f1a07f72a85abbbfea122941d6a7dac5fead25ac42c21a3a23` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/final_frozen_state/artifacts/retry_block_report.csv` hash matches `bbbdbe8eabf869147eec640576077f6cc82195e86b7f325fb250974ea7e00a81` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/final_frozen_state/artifacts/retry_block_report.md` hash matches `a15a00fec6cee3126de2bc813b40e0aa0cf4d875e747f8d9e37a8606a3ad40a8` |
