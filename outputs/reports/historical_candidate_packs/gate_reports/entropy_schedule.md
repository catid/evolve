...
- candidate result pack: `outputs/reports/historical_candidate_packs/entropy_schedule/entropy_schedule.json`
...
| candidate_name | `PASS` | candidate name is `entropy_schedule` |
...
| evaluation | `FAIL` | candidate evaluation `{'episodes': 32, 'path_key': 'entropy_schedule_sweep'}` does not match frozen `{'episodes': 64, 'path_key': 'external_policy_diagnostics', 'path_text': 'external 64-episode policy_diagnostics path', 'task': 'DoorKey'}` |
...
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/candidate_metrics.json` hash matches `ae57028cf01703859e658568f697bf9bb6696566d8683c5a0ed208ab94ed1203` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/candidate_summary.md` hash matches `8b5bed2ba09fc118635b3e9a97838428311b25b891eb41e9fadc88c45a7b9c0b` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/combined_report.csv` hash matches `ba1bebada7d2cd352404389d75e7a31a03ca340b231a2252a3d316afb9f6fe61` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/combined_report.md` hash matches `23125b2f936ec440f4811f929fc13fa1e71ab6d0ca83eef33f3dfca0a44300d0` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/retry_block_report.csv` hash matches `5d71b9e014f3ffdeee6afb2392744b27d16f8171c4f8871c9e21035f3127562d` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/retry_block_report.md` hash matches `8af6001f2a239e016515875ba8e29caca2b26b983f647c27e1c8e8ecbac477ec` |
...
| candidate_pack::candidate_name | `PASS` | candidate name is `entropy_schedule` |
...
| candidate_pack::evaluation | `INCONCLUSIVE` | candidate evaluation `{'episodes': 32, 'path_key': 'entropy_schedule_sweep'}` does not match frozen `{'episodes': 64, 'path_key': 'external_policy_diagnostics', 'path_text': 'external 64-episode policy_diagnostics path', 'task': 'DoorKey'}` |
...
| candidate_pack::artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/candidate_metrics.json` hash matches `ae57028cf01703859e658568f697bf9bb6696566d8683c5a0ed208ab94ed1203` |
| candidate_pack::artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/candidate_summary.md` hash matches `8b5bed2ba09fc118635b3e9a97838428311b25b891eb41e9fadc88c45a7b9c0b` |
| candidate_pack::artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/combined_report.csv` hash matches `ba1bebada7d2cd352404389d75e7a31a03ca340b231a2252a3d316afb9f6fe61` |
| candidate_pack::artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/combined_report.md` hash matches `23125b2f936ec440f4811f929fc13fa1e71ab6d0ca83eef33f3dfca0a44300d0` |
| candidate_pack::artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/retry_block_report.csv` hash matches `5d71b9e014f3ffdeee6afb2392744b27d16f8171c4f8871c9e21035f3127562d` |
| candidate_pack::artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/entropy_schedule/artifacts/retry_block_report.md` hash matches `8af6001f2a239e016515875ba8e29caca2b26b983f647c27e1c8e8ecbac477ec` |
