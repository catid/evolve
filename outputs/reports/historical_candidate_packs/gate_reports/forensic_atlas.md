...
- candidate result pack: `outputs/reports/historical_candidate_packs/forensic_atlas/forensic_atlas.json`
...
| candidate_name | `PASS` | candidate name is `forensic_atlas` |
...
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/forensic_atlas/artifacts/candidate_metrics.json` hash matches `d321006a1aab6879870265de029a4baf3cd27903f05973e7a49349e1308ec040` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/forensic_atlas/artifacts/candidate_summary.md` hash matches `3fb22c4552777f13857358c4d5eee4788a2224704790f90b274ff902d7108826` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/forensic_atlas/artifacts/combined_report.csv` hash matches `fe90ab291deac9322e605cf1b892f6e6c1703fe47d72914c35c85881c7c3007f` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/forensic_atlas/artifacts/combined_report.md` hash matches `bc035035f69312ab4072b0072f73921fedeb39accc9f6f239b6b42029e9f4086` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/forensic_atlas/artifacts/retry_block_report.csv` hash matches `bbbdbe8eabf869147eec640576077f6cc82195e86b7f325fb250974ea7e00a81` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/forensic_atlas/artifacts/retry_block_report.md` hash matches `f4f2f577abde6b9c0b319f75efe9a90de686d36f9332cefd497c8fbd8f9bb3f8` |
