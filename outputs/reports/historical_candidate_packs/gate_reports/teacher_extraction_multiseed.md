...
- candidate result pack: `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/teacher_extraction_multiseed.json`
...
| candidate_name | `PASS` | candidate name is `teacher_extraction_multiseed` |
...
| controls_present | `FAIL` | candidate is missing required controls: `kl_lss_single_expert`, `kl_lss_token_dense` |
| metrics.combined.type | `PASS` | combined metrics are a mapping |
| metrics.retry_block.type | `PASS` | retry-block metrics are a mapping |
| metrics.combined | `FAIL` | combined metrics are missing fields: `kl_lss_single_expert:<variant>`, `kl_lss_token_dense:<variant>` |
| metrics.retry_block | `FAIL` | retry-block metrics are missing fields: `kl_lss_single_expert:<variant>`, `kl_lss_token_dense:<variant>` |
| actual_sets.combined | `FAIL` | candidate combined lane/seed set `[('original', 7), ('original', 11), ('original', 19)]` does not match frozen `[('fresh', 23), ('fresh', 29), ('fresh', 31), ('fresh_extra', 37), ('fresh_extra', 41), ('fresh_extra', 43), ('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59), ('original', 7), ('original', 11), ('original', 19)]` |
| actual_sets.retry_block | `FAIL` | candidate retry-block lane/seed set `[('original', 7), ('original', 11), ('original', 19)]` does not match frozen `[('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59)]` |
| artifacts.duplicates | `PASS` | artifact roles are unique |
| artifacts | `PASS` | candidate pack exposes all required artifact roles |
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/candidate_metrics.json` hash matches `28cd72d7b73a306e7ad3eb1812a4bda642573e61f1aeb46c39cc99787c7ef2db` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/candidate_summary.md` hash matches `2c028728d3e54dec8619d2a7ebf137bfeb7538384e1b4863ced116e3c3c9d2c7` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/combined_report.csv` hash matches `1baaa8ffba37bfe3cba76a682f3986edb8d09d6ef36d405796b3b1b76870dfb4` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/combined_report.md` hash matches `a54bb69986b0b3336608adebfcea341f77c52a95e1008848d0f965e591421485` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/retry_block_report.csv` hash matches `1baaa8ffba37bfe3cba76a682f3986edb8d09d6ef36d405796b3b1b76870dfb4` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/retry_block_report.md` hash matches `89572f9cece95ebe062a92b902cf68f521a99a958e962486f973fe5449feb311` |
...
| candidate_pack::candidate_name | `PASS` | candidate name is `teacher_extraction_multiseed` |
...
| candidate_pack::controls_present | `INCONCLUSIVE` | candidate is missing required controls: `kl_lss_single_expert`, `kl_lss_token_dense` |
...
| candidate_pack::metrics.combined | `INCONCLUSIVE` | combined metrics are missing fields: `kl_lss_single_expert:<variant>`, `kl_lss_token_dense:<variant>` |
| candidate_pack::metrics.retry_block | `INCONCLUSIVE` | retry-block metrics are missing fields: `kl_lss_single_expert:<variant>`, `kl_lss_token_dense:<variant>` |
| candidate_pack::actual_sets.combined | `INCONCLUSIVE` | candidate combined lane/seed set `[('original', 7), ('original', 11), ('original', 19)]` does not match frozen `[('fresh', 23), ('fresh', 29), ('fresh', 31), ('fresh_extra', 37), ('fresh_extra', 41), ('fresh_extra', 43), ('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59), ('original', 7), ('original', 11), ('original', 19)]` |
| candidate_pack::actual_sets.retry_block | `INCONCLUSIVE` | candidate retry-block lane/seed set `[('original', 7), ('original', 11), ('original', 19)]` does not match frozen `[('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59)]` |
...
| candidate_pack::artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/candidate_metrics.json` hash matches `28cd72d7b73a306e7ad3eb1812a4bda642573e61f1aeb46c39cc99787c7ef2db` |
| candidate_pack::artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/candidate_summary.md` hash matches `2c028728d3e54dec8619d2a7ebf137bfeb7538384e1b4863ced116e3c3c9d2c7` |
| candidate_pack::artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/combined_report.csv` hash matches `1baaa8ffba37bfe3cba76a682f3986edb8d09d6ef36d405796b3b1b76870dfb4` |
| candidate_pack::artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/combined_report.md` hash matches `a54bb69986b0b3336608adebfcea341f77c52a95e1008848d0f965e591421485` |
| candidate_pack::artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/retry_block_report.csv` hash matches `1baaa8ffba37bfe3cba76a682f3986edb8d09d6ef36d405796b3b1b76870dfb4` |
| candidate_pack::artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/teacher_extraction_multiseed/artifacts/retry_block_report.md` hash matches `89572f9cece95ebe062a92b902cf68f521a99a958e962486f973fe5449feb311` |
