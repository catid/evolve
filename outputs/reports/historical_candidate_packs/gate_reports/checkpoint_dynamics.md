...
- candidate result pack: `outputs/reports/historical_candidate_packs/checkpoint_dynamics/checkpoint_dynamics.json`
...
| candidate_name | `PASS` | candidate name is `checkpoint_dynamics` |
...
| evaluation | `FAIL` | candidate evaluation `{'episodes': 32, 'path_key': 'checkpoint_dynamics_scan'}` does not match frozen `{'episodes': 64, 'path_key': 'external_policy_diagnostics', 'path_text': 'external 64-episode policy_diagnostics path', 'task': 'DoorKey'}` |
...
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/candidate_metrics.json` hash matches `30fafd89cea6f8451a449bc64fbb0eb7c8b74239cc1ec427649bba87d4012381` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/candidate_summary.md` hash matches `a3ced80076aaa380660438f4ba6b3736ba6dd3db1a493752069d1119d632b187` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/combined_report.csv` hash matches `eeb430dba9ae8d91d9557144e2dc44813c3b2f6996dc7839c4b999ecca9cfde5` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/combined_report.md` hash matches `b00140cbe30b6b8700a728da7dbfc4d16dd9822209dc414278a3458bcc206340` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/retry_block_report.csv` hash matches `5d71b9e014f3ffdeee6afb2392744b27d16f8171c4f8871c9e21035f3127562d` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/retry_block_report.md` hash matches `fc1710d17c1719a2bf88ed17e3ffef6f89fab019723a680c519a5dd822cf448f` |
...
| candidate_pack::candidate_name | `PASS` | candidate name is `checkpoint_dynamics` |
...
| candidate_pack::evaluation | `INCONCLUSIVE` | candidate evaluation `{'episodes': 32, 'path_key': 'checkpoint_dynamics_scan'}` does not match frozen `{'episodes': 64, 'path_key': 'external_policy_diagnostics', 'path_text': 'external 64-episode policy_diagnostics path', 'task': 'DoorKey'}` |
...
| candidate_pack::artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/candidate_metrics.json` hash matches `30fafd89cea6f8451a449bc64fbb0eb7c8b74239cc1ec427649bba87d4012381` |
| candidate_pack::artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/candidate_summary.md` hash matches `a3ced80076aaa380660438f4ba6b3736ba6dd3db1a493752069d1119d632b187` |
| candidate_pack::artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/combined_report.csv` hash matches `eeb430dba9ae8d91d9557144e2dc44813c3b2f6996dc7839c4b999ecca9cfde5` |
| candidate_pack::artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/combined_report.md` hash matches `b00140cbe30b6b8700a728da7dbfc4d16dd9822209dc414278a3458bcc206340` |
| candidate_pack::artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/retry_block_report.csv` hash matches `5d71b9e014f3ffdeee6afb2392744b27d16f8171c4f8871c9e21035f3127562d` |
| candidate_pack::artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/checkpoint_dynamics/artifacts/retry_block_report.md` hash matches `fc1710d17c1719a2bf88ed17e3ffef6f89fab019723a680c519a5dd822cf448f` |
...
| claim_scope | `FAIL` | candidate requests disallowed widening: `ppo_only_routed_win` |
