...
- candidate result pack: `outputs/reports/historical_candidate_packs/claim_hardening/claim_hardening.json`
...
| candidate_name | `PASS` | candidate name is `claim_hardening` |
...
| controls_present | `FAIL` | candidate is missing required controls: `kl_lss_single_expert` |
| metrics.combined.type | `PASS` | combined metrics are a mapping |
| metrics.retry_block.type | `PASS` | retry-block metrics are a mapping |
| metrics.combined | `FAIL` | combined metrics are missing fields: `kl_lss_single_expert:<variant>` |
| metrics.retry_block | `FAIL` | retry-block metrics are missing fields: `kl_lss_single_expert:<variant>`, `kl_lss_token_dense:<variant>` |
| actual_sets.combined | `FAIL` | candidate combined lane/seed set `[('fresh', 23), ('fresh', 29), ('fresh', 31), ('original', 7), ('original', 11), ('original', 19)]` does not match frozen `[('fresh', 23), ('fresh', 29), ('fresh', 31), ('fresh_extra', 37), ('fresh_extra', 41), ('fresh_extra', 43), ('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59), ('original', 7), ('original', 11), ('original', 19)]` |
| actual_sets.retry_block | `FAIL` | candidate retry-block lane/seed set `[('fresh', 23), ('fresh', 29), ('fresh', 31)]` does not match frozen `[('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59)]` |
| artifacts.duplicates | `PASS` | artifact roles are unique |
| artifacts | `PASS` | candidate pack exposes all required artifact roles |
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/candidate_metrics.json` hash matches `02612298c2636d676d75a639a09e87cc7b9dbdf699306d638609efe116a0419a` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/candidate_summary.md` hash matches `e5fe768cc3d8195e6e8818d9b2399b0a4abcb531d51676b47f6b4caabd06b6e2` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/combined_report.csv` hash matches `8a244af23b350a0b653e3ba93cfe27c6bb6d12f68e062427600a06fdd9244cfc` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/combined_report.md` hash matches `e19b8f616bff3c30b8f84e821537b43f4b3ce2ed6d1e83ccaf94266e4c344632` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/retry_block_report.csv` hash matches `435c051943db284b61b74130ddc14d80ad12620db4078a9ffe60a44d785843c6` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/retry_block_report.md` hash matches `a78d826ccc23f5ac350e49145724c0b597f6492982169bbfcbef349bfa230282` |
...
| candidate_pack::candidate_name | `PASS` | candidate name is `claim_hardening` |
...
| candidate_pack::controls_present | `INCONCLUSIVE` | candidate is missing required controls: `kl_lss_single_expert` |
...
| candidate_pack::metrics.combined | `INCONCLUSIVE` | combined metrics are missing fields: `kl_lss_single_expert:<variant>` |
...
| candidate_pack::actual_sets.combined | `INCONCLUSIVE` | candidate combined lane/seed set `[('fresh', 23), ('fresh', 29), ('fresh', 31), ('original', 7), ('original', 11), ('original', 19)]` does not match frozen `[('fresh', 23), ('fresh', 29), ('fresh', 31), ('fresh_extra', 37), ('fresh_extra', 41), ('fresh_extra', 43), ('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59), ('original', 7), ('original', 11), ('original', 19)]` |
| candidate_pack::actual_sets.retry_block | `INCONCLUSIVE` | candidate retry-block lane/seed set `[('fresh', 23), ('fresh', 29), ('fresh', 31)]` does not match frozen `[('fresh_final', 47), ('fresh_final', 53), ('fresh_final', 59)]` |
...
| candidate_pack::artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/candidate_metrics.json` hash matches `02612298c2636d676d75a639a09e87cc7b9dbdf699306d638609efe116a0419a` |
| candidate_pack::artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/candidate_summary.md` hash matches `e5fe768cc3d8195e6e8818d9b2399b0a4abcb531d51676b47f6b4caabd06b6e2` |
| candidate_pack::artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/combined_report.csv` hash matches `8a244af23b350a0b653e3ba93cfe27c6bb6d12f68e062427600a06fdd9244cfc` |
| candidate_pack::artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/combined_report.md` hash matches `e19b8f616bff3c30b8f84e821537b43f4b3ce2ed6d1e83ccaf94266e4c344632` |
| candidate_pack::artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/retry_block_report.csv` hash matches `435c051943db284b61b74130ddc14d80ad12620db4078a9ffe60a44d785843c6` |
| candidate_pack::artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/claim_hardening/artifacts/retry_block_report.md` hash matches `a78d826ccc23f5ac350e49145724c0b597f6492982169bbfcbef349bfa230282` |
