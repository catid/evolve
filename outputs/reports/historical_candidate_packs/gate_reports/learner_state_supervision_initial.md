...
- candidate result pack: `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/learner_state_supervision_initial.json`
...
| candidate_name | `PASS` | candidate name is `learner_state_supervision_initial` |
...
| evaluation | `FAIL` | candidate evaluation `{'episodes': 64, 'path_key': 'learner_state_round_summary'}` does not match frozen `{'episodes': 64, 'path_key': 'external_policy_diagnostics', 'path_text': 'external 64-episode policy_diagnostics path', 'task': 'DoorKey'}` |
...
| controls_present | `FAIL` | candidate is missing required controls: `baseline_sare`, `kl_lss_single_expert`, `kl_lss_token_dense`, `recovered_token_dense` |
| metrics.combined.type | `PASS` | combined metrics are a mapping |
| metrics.retry_block.type | `PASS` | retry-block metrics are a mapping |
| metrics.combined | `FAIL` | combined metrics are missing fields: `baseline_sare:<variant>`, `kl_lss_single_expert:<variant>`, `recovered_token_dense:<variant>` |
...
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/candidate_metrics.json` hash matches `36cef66bf37757f1a0b0e945679299a2c2933b993bbbf209434bdc358a3c503d` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/candidate_summary.md` hash matches `58782e90102d83f634b9d3a81b9f604f2c4ca0fb57e7d764c310f2d05ddb5f17` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/combined_report.csv` hash matches `df3bcdd4036e62705fffa60c58312e0119bc27c134fee114e492efc9cc66e854` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/combined_report.md` hash matches `e941a98ebe70a765c8c583e6bc5f32547a45b2316f4230726524b5b312b68394` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/retry_block_report.csv` hash matches `5d71b9e014f3ffdeee6afb2392744b27d16f8171c4f8871c9e21035f3127562d` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/retry_block_report.md` hash matches `4174a0eaeca0ab6b0992dc655756b3c5c920fcb33ba05bd28d0278a872bdb6fa` |
...
| candidate_pack::candidate_name | `PASS` | candidate name is `learner_state_supervision_initial` |
...
| candidate_pack::evaluation | `INCONCLUSIVE` | candidate evaluation `{'episodes': 64, 'path_key': 'learner_state_round_summary'}` does not match frozen `{'episodes': 64, 'path_key': 'external_policy_diagnostics', 'path_text': 'external 64-episode policy_diagnostics path', 'task': 'DoorKey'}` |
...
| candidate_pack::controls_present | `INCONCLUSIVE` | candidate is missing required controls: `baseline_sare`, `kl_lss_single_expert`, `kl_lss_token_dense`, `recovered_token_dense` |
...
| candidate_pack::metrics.combined | `INCONCLUSIVE` | combined metrics are missing fields: `baseline_sare:<variant>`, `kl_lss_single_expert:<variant>`, `recovered_token_dense:<variant>` |
...
| candidate_pack::artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/candidate_metrics.json` hash matches `36cef66bf37757f1a0b0e945679299a2c2933b993bbbf209434bdc358a3c503d` |
| candidate_pack::artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/candidate_summary.md` hash matches `58782e90102d83f634b9d3a81b9f604f2c4ca0fb57e7d764c310f2d05ddb5f17` |
| candidate_pack::artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/combined_report.csv` hash matches `df3bcdd4036e62705fffa60c58312e0119bc27c134fee114e492efc9cc66e854` |
| candidate_pack::artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/combined_report.md` hash matches `e941a98ebe70a765c8c583e6bc5f32547a45b2316f4230726524b5b312b68394` |
| candidate_pack::artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/retry_block_report.csv` hash matches `5d71b9e014f3ffdeee6afb2392744b27d16f8171c4f8871c9e21035f3127562d` |
| candidate_pack::artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/learner_state_supervision_initial/artifacts/retry_block_report.md` hash matches `4174a0eaeca0ab6b0992dc655756b3c5c920fcb33ba05bd28d0278a872bdb6fa` |
