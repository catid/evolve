...
- candidate result pack: `outputs/reports/historical_candidate_packs/policy_distillation/policy_distillation.json`
...
| candidate_name | `PASS` | candidate name is `policy_distillation` |
...
| evaluation | `FAIL` | candidate evaluation `{'episodes': 64, 'path_key': 'offline_policy_distillation'}` does not match frozen `{'episodes': 64, 'path_key': 'external_policy_diagnostics', 'path_text': 'external 64-episode policy_diagnostics path', 'task': 'DoorKey'}` |
...
| metrics.combined | `FAIL` | combined metrics are missing fields: `baseline_sare:<variant>`, `kl_lss_sare:<variant>`, `kl_lss_single_expert:<variant>`, `kl_lss_token_dense:<variant>`, `recovered_token_dense:<variant>` |
...
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/candidate_metrics.json` hash matches `b6ed0e1151a29e6156c8c2b9244208c713914ce5380e2cccafebca43ea4904bb` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/candidate_summary.md` hash matches `35e46d5e4897582ee3c292625ec183adf4a804855229fe86c28f7cc699488085` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/combined_report.csv` hash matches `b54cbd289364e5a2bcde2609cb5eef392fe48c384bdcdead1fb882a3542df28d` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/combined_report.md` hash matches `0a9091f1aba01ad6c4b621b7b7f325736e24afcbdc077b73dfa958511d375940` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/retry_block_report.csv` hash matches `5d71b9e014f3ffdeee6afb2392744b27d16f8171c4f8871c9e21035f3127562d` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/retry_block_report.md` hash matches `d0fb3d71758a39cf74229d3051cb3c6178b5ea4b7a8c99be99ba73a39f0d980a` |
...
| candidate_pack::candidate_name | `PASS` | candidate name is `policy_distillation` |
...
| candidate_pack::evaluation | `INCONCLUSIVE` | candidate evaluation `{'episodes': 64, 'path_key': 'offline_policy_distillation'}` does not match frozen `{'episodes': 64, 'path_key': 'external_policy_diagnostics', 'path_text': 'external 64-episode policy_diagnostics path', 'task': 'DoorKey'}` |
...
| candidate_pack::metrics.combined | `INCONCLUSIVE` | combined metrics are missing fields: `baseline_sare:<variant>`, `kl_lss_sare:<variant>`, `kl_lss_single_expert:<variant>`, `kl_lss_token_dense:<variant>`, `recovered_token_dense:<variant>` |
...
| candidate_pack::artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/candidate_metrics.json` hash matches `b6ed0e1151a29e6156c8c2b9244208c713914ce5380e2cccafebca43ea4904bb` |
| candidate_pack::artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/candidate_summary.md` hash matches `35e46d5e4897582ee3c292625ec183adf4a804855229fe86c28f7cc699488085` |
| candidate_pack::artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/combined_report.csv` hash matches `b54cbd289364e5a2bcde2609cb5eef392fe48c384bdcdead1fb882a3542df28d` |
| candidate_pack::artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/combined_report.md` hash matches `0a9091f1aba01ad6c4b621b7b7f325736e24afcbdc077b73dfa958511d375940` |
| candidate_pack::artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/retry_block_report.csv` hash matches `5d71b9e014f3ffdeee6afb2392744b27d16f8171c4f8871c9e21035f3127562d` |
| candidate_pack::artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/historical_candidate_packs/policy_distillation/artifacts/retry_block_report.md` hash matches `d0fb3d71758a39cf74229d3051cb3c6178b5ea4b7a8c99be99ba73a39f0d980a` |
