...
| provenance.sealed_source_commit | `PASS` | sealed source commit `7a5b35e2829ddbcbaf1eaea6cf59614070f5a33e` is well formed |
...
| artifact_hash::frozen_claim_envelope | `PASS` | artifact `outputs/reports/frozen_claim_envelope.md` hash matches `f27bf0ef77d41823ef407de83af4ee97673d863bb9f3214fe9a129ee1d473f3c` |
...
| artifact_hash::frozen_validation_json | `PASS` | artifact `outputs/reports/frozen_baseline_validation.json` hash matches `03f5b1d49e3effdbf508aa69e12842a35cb06d365f0b9bd1e3dca0bf9c048351` |
| artifact_hash::frozen_validation_report | `PASS` | artifact `outputs/reports/frozen_baseline_validation.md` hash matches `e068beabe92f80c105345bf900c528b448d7f133906478ff152497f8a6b28063` |
...
| frozen_pack_reference.sha256 | `PASS` | candidate references frozen-pack hash `1d0bdccf1a16e0368f087ed73952b41ed4647a48d1c7dbed917da7dde41ac9ae` |
...
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/frozen_baseline_validation.json` hash matches `03f5b1d49e3effdbf508aa69e12842a35cb06d365f0b9bd1e3dca0bf9c048351` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/frozen_baseline_validation.md` hash matches `e068beabe92f80c105345bf900c528b448d7f133906478ff152497f8a6b28063` |
...
| provenance.git_commit | `PASS` | candidate provenance git_commit `7a5b35e2829ddbcbaf1eaea6cf59614070f5a33e` is well formed |
