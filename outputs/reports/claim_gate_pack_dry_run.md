...
- candidate result pack: `outputs/reports/frozen_candidate_result_pack.json`
...
| artifact_hash::claim_gate_dry_run | `PASS` | artifact `outputs/reports/claim_gate_dry_run.md` hash matches `dff3558d5deca2813ad46f696e9a6e6090fe1f2efd85c57b90bc63bfaea61616` |
| artifact_hash::claim_gate_dry_run_json | `PASS` | artifact `outputs/reports/claim_gate_dry_run.json` hash matches `2a2b08864bcf16de89123b87e2cfe946e3ee0757cd1b3901b4f5f130df353e96` |
| artifact_hash::claim_ledger | `PASS` | artifact `outputs/reports/claim_ledger.md` hash matches `edce380e5fb0f3224e18fd1612e2c809ec54d109c756f428e869a93905122487` |
...
| artifact_hash::frozen_claim_envelope | `PASS` | artifact `outputs/reports/frozen_claim_envelope.md` hash matches `9e27aae6c2d5fa1125a490045436c838e052c5ae38ac71d437c13a58a51dec16` |
...
| artifact_hash::frozen_validation_json | `PASS` | artifact `outputs/reports/frozen_baseline_validation.json` hash matches `eb99e4bd94fd436ee7d78852b1366fdabc922f3b7327afc8b857f32db8695152` |
| artifact_hash::frozen_validation_report | `PASS` | artifact `outputs/reports/frozen_baseline_validation.md` hash matches `ee5776dc56290d9a281a900f9dd2dd395f3432f655a405eca086c387ad2e5af3` |
...
| frozen_pack_reference.sha256 | `PASS` | candidate references frozen-pack hash `983f80b4e95db317de8ee402394fcc666df38e8c2f9d229950b5dfe8ee75cd41` |
...
| artifact_hash::candidate_metrics_json | `PASS` | candidate artifact `outputs/reports/frozen_baseline_validation.json` hash matches `eb99e4bd94fd436ee7d78852b1366fdabc922f3b7327afc8b857f32db8695152` |
| artifact_hash::candidate_summary_markdown | `PASS` | candidate artifact `outputs/reports/frozen_baseline_validation.md` hash matches `ee5776dc56290d9a281a900f9dd2dd395f3432f655a405eca086c387ad2e5af3` |
| artifact_hash::combined_report_csv | `PASS` | candidate artifact `outputs/reports/lss_frozen_claim_updated_combined_doorkey_report.csv` hash matches `f0c83d833ef9bfe3fa9e2db97f10e5bc42f6c1ab42805c14b21aa53ca0744b3b` |
| artifact_hash::combined_report_markdown | `PASS` | candidate artifact `outputs/reports/lss_frozen_claim_updated_combined_doorkey_report.md` hash matches `e0cdd2b799538aad926156a19bdf88da19cb8c62a091ab16799a3e94cc87e19d` |
| artifact_hash::retry_block_report_csv | `PASS` | candidate artifact `outputs/reports/lss_final_block_single_expert_control_report.csv` hash matches `8a7c5491529286337be0a727d2a71649ca4804b0e33efe8eba497354f46f7f2c` |
| artifact_hash::retry_block_report_markdown | `PASS` | candidate artifact `outputs/reports/lss_final_block_single_expert_control_report.md` hash matches `084c6b96a5dfac5536af36009fe08664a42b21a61b230a3a03aa5e48a772812f` |
