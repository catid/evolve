...
| frozen_pack::provenance.sealed_source_commit | `PASS` | sealed source commit `21a890285831feb89c6de03ea16619239ff732e3` is well formed |
...
| frozen_pack::artifact_hash::frozen_claim_envelope | `PASS` | artifact `outputs/reports/frozen_claim_envelope.md` hash matches `566d777b34a002a98719e2e8f56d2e20c61868b15f6151fa52115125048e8dcf` |
...
| frozen_pack::artifact_hash::frozen_validation_json | `PASS` | artifact `outputs/reports/frozen_baseline_validation.json` hash matches `f8aa55424502e42c03bdd20eaa920ad24f4fdc20a4105bd92620e7b6a3498ba9` |
| frozen_pack::artifact_hash::frozen_validation_report | `PASS` | artifact `outputs/reports/frozen_baseline_validation.md` hash matches `f778f060dded331c9eec1e7b22dea04420698494249218a3020e466e42dd23df` |
...
| candidate_pack::frozen_pack_reference.sha256 | `PASS` | candidate references frozen-pack hash `0426cb3a034046523769ad6066188796a684ce2cc7553468ed8c00f1e73f0a3c` |
...
| candidate_pack::provenance.git_commit | `PASS` | candidate provenance git_commit `21a890285831feb89c6de03ea16619239ff732e3` is well formed |
