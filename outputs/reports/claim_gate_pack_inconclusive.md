...
| frozen_pack::artifact_hash::claim_gate_dry_run | `PASS` | artifact `outputs/reports/claim_gate_dry_run.md` hash matches `dff3558d5deca2813ad46f696e9a6e6090fe1f2efd85c57b90bc63bfaea61616` |
| frozen_pack::artifact_hash::claim_gate_dry_run_json | `PASS` | artifact `outputs/reports/claim_gate_dry_run.json` hash matches `2a2b08864bcf16de89123b87e2cfe946e3ee0757cd1b3901b4f5f130df353e96` |
| frozen_pack::artifact_hash::claim_ledger | `PASS` | artifact `outputs/reports/claim_ledger.md` hash matches `edce380e5fb0f3224e18fd1612e2c809ec54d109c756f428e869a93905122487` |
...
| frozen_pack::artifact_hash::frozen_claim_envelope | `PASS` | artifact `outputs/reports/frozen_claim_envelope.md` hash matches `bef4f19a6c41cf1f8545d5aa893942e3c735d9a033d36706a0da4037052d5b01` |
...
| frozen_pack::artifact_hash::frozen_validation_json | `PASS` | artifact `outputs/reports/frozen_baseline_validation.json` hash matches `3cca58ab671490cf6361f52cacb6478d163a4be5aaac07c3fbf438415bb884fc` |
| frozen_pack::artifact_hash::frozen_validation_report | `PASS` | artifact `outputs/reports/frozen_baseline_validation.md` hash matches `ee2b6485c33762cd1b9d72338c48d51a6617efb31c12d53818b5d2422aeb34f1` |
...
| candidate_pack::frozen_pack_reference.sha256 | `PASS` | candidate references frozen-pack hash `ee4e6d5076c1b090289d56e480a48b6dcff4fe816f6ba27703eefcdc4a5594d7` |
