...
| frozen_pack::provenance.sealed_source_commit | `PASS` | sealed source commit `adb5d321cb47166796fd17e87efee8d6cb027c64` is well formed |
...
| frozen_pack::artifact_hash::claim_ledger | `PASS` | artifact `outputs/reports/claim_ledger.md` hash matches `4145f1f38643a7742410eeedf48713123a10cf225eef0cf4dfe80f8e95b9054e` |
...
| frozen_pack::artifact_hash::frozen_claim_envelope | `PASS` | artifact `outputs/reports/frozen_claim_envelope.md` hash matches `adbc2d922d06bd54a1649c8272fba7756765cf0290de0d6944afe6db8ab7d31e` |
...
| frozen_pack::artifact_hash::frozen_validation_json | `PASS` | artifact `outputs/reports/frozen_baseline_validation.json` hash matches `114c4479135dc4ee64adf4c8443c0aebfde65a5c38cbf9f42150952872198a9c` |
| frozen_pack::artifact_hash::frozen_validation_report | `PASS` | artifact `outputs/reports/frozen_baseline_validation.md` hash matches `28e91e0173616dea787564cea650e52a0ad037391f76fd9927fb9d7fc858a0b7` |
...
| candidate_pack::frozen_pack_reference.sha256 | `PASS` | candidate references frozen-pack hash `3d69d09954b91d986aac078ab70eede1bea3150d79e28e34124207d2e8a0d08f` |
...
| candidate_pack::provenance.git_commit | `PASS` | candidate provenance git_commit `adb5d321cb47166796fd17e87efee8d6cb027c64` is well formed |
