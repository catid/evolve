...
OUTPUT_ROOT="${PSMN_OUTPUT_ROOT:-outputs/experiments/token_recovery}"
...
CONFIGS=(
  ...
  "configs/experiments/minigrid_doorkey_token_dense_ent0.yaml"
  "configs/experiments/minigrid_doorkey_single_expert_ent1e3.yaml"
  "configs/experiments/minigrid_doorkey_single_expert_ent0.yaml"
)
...
python -m psmn_rl.analysis.policy_diagnostics \
  ...
  --trace-dir outputs/reports/token_recovery_traces \
