...
ROOT="outputs/experiments/memory_actor_hidden_upper_shift_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_upper_shift_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_upper_shift_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift30.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift35.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_upper_shift_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_upper_shift_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift25",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_upper_shift_probe/memory_por_switchy_actor_hidden_partial_shift25"),
        "variant": "partial_shift_0.25",
    },
    {
        "label": "por_actor_hidden_partial_shift30",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_upper_shift_probe/memory_por_switchy_actor_hidden_partial_shift30"),
        "variant": "partial_shift_0.30",
    },
    {
        "label": "por_actor_hidden_partial_shift35",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_upper_shift_probe/memory_por_switchy_actor_hidden_partial_shift35"),
        "variant": "partial_shift_0.35",
    },
]
...
por_shift30 = row("por_actor_hidden_partial_shift30")
por_shift35 = row("por_actor_hidden_partial_shift35")
...
for item in (por_base, por_shift25, por_shift30, por_shift35):
    lines.append(
...
lines.extend(
    [
        ...
        f"| `por_actor_hidden_partial_shift30` | `{por_shift30['greedy/success'] - por_base['greedy/success']:+.4f}` | `{por_shift30['lower_t005/success'] - por_base['lower_t005/success']:+.4f}` | `{por_shift30['gap_t0055/success'] - por_base['gap_t0055/success']:+.4f}` | `{por_shift30['shoulder_t008/success'] - por_base['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift35` | `{por_shift35['greedy/success'] - por_base['greedy/success']:+.4f}` | `{por_shift35['lower_t005/success'] - por_base['lower_t005/success']:+.4f}` | `{por_shift35['gap_t0055/success'] - por_base['gap_t0055/success']:+.4f}` | `{por_shift35['shoulder_t008/success'] - por_base['shoulder_t008/success']:+.4f}` |",
        "",
        "## Deltas vs Partial-Shift25 Reference",
        "",
        "| Variant | Delta Greedy | Delta Lower | Delta Gap | Delta Shoulder |",
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift30` | `{por_shift30['greedy/success'] - por_shift25['greedy/success']:+.4f}` | `{por_shift30['lower_t005/success'] - por_shift25['lower_t005/success']:+.4f}` | `{por_shift30['gap_t0055/success'] - por_shift25['gap_t0055/success']:+.4f}` | `{por_shift30['shoulder_t008/success'] - por_shift25['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift35` | `{por_shift35['greedy/success'] - por_shift25['greedy/success']:+.4f}` | `{por_shift35['lower_t005/success'] - por_shift25['lower_t005/success']:+.4f}` | `{por_shift35['gap_t0055/success'] - por_shift25['gap_t0055/success']:+.4f}` | `{por_shift35['shoulder_t008/success'] - por_shift25['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
