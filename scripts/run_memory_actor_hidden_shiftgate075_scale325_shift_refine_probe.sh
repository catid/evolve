...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_refine_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale325_shift_refine_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale325_shift_refine_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift215_shiftgate075_scale325.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225_shiftgate075_scale325.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale325_shift_refine_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_refine_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_refine_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_refine_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shift22_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift215_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_refine_probe/memory_por_switchy_actor_hidden_partial_shift215_shiftgate075_scale325"),
        "variant": "shift215_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift225_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_refine_probe/memory_por_switchy_actor_hidden_partial_shift225_shiftgate075_scale325"),
        "variant": "shift225_shiftgate075_scale325",
    },
]
...
shift22_scale325 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325")
shift215_scale325 = row("por_actor_hidden_partial_shift215_shiftgate075_scale325")
shift225_scale325 = row("por_actor_hidden_partial_shift225_shiftgate075_scale325")

lines = [
    "# Memory ShiftGate075 Scale325 Shift-Weight Probe",
    "",
    "- hypothesis: once `shiftgate075_scale325` is alive, the best local surface may want a nearby hidden shift weight rather than the base `0.22`",
...
for item in (por_base, por_shift22, shift22_scale325, shift215_scale325, shift225_scale325):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift215_shiftgate075_scale325` | `{shift215_scale325['greedy/success'] - shift22_scale325['greedy/success']:+.4f}` | `{shift215_scale325['lower_t005/success'] - shift22_scale325['lower_t005/success']:+.4f}` | `{shift215_scale325['gap_t0055/success'] - shift22_scale325['gap_t0055/success']:+.4f}` | `{shift215_scale325['shoulder_t008/success'] - shift22_scale325['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift225_shiftgate075_scale325` | `{shift225_scale325['greedy/success'] - shift22_scale325['greedy/success']:+.4f}` | `{shift225_scale325['lower_t005/success'] - shift22_scale325['lower_t005/success']:+.4f}` | `{shift225_scale325['gap_t0055/success'] - shift22_scale325['gap_t0055/success']:+.4f}` | `{shift225_scale325['shoulder_t008/success'] - shift22_scale325['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)
...
interesting = any(
    ...
    and (
        item["greedy/success"] > shift22_scale325["greedy/success"]
        or item["lower_t005/success"] > shift22_scale325["lower_t005/success"]
        or item["gap_t0055/success"] > shift22_scale325["gap_t0055/success"]
        or item["shoulder_t008/success"] > shift22_scale325["shoulder_t008/success"]
    )
    for item in (shift215_scale325, shift225_scale325)
)

if interesting:
    lines.append("- conclusion: at least one shift-weight refinement preserves nonzero greedy and improves part of the restored `shiftgate075_scale325` surface; run a 256-episode confirmation pass before treating it as real")
else:
    lines.append("- conclusion: retuning hidden shift weight around `shiftgate075_scale325` does not improve the restored local surface")
