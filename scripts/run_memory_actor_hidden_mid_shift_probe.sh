...
ROOT="outputs/experiments/memory_actor_hidden_mid_shift_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_mid_shift_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_mid_shift_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift24.yaml"
...
manifest = {
    ...
    "family": "memory_actor_hidden_mid_shift_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_mid_shift_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift225",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_mid_shift_probe/memory_por_switchy_actor_hidden_partial_shift225"),
        "variant": "partial_shift_0.225",
    },
    {
        "label": "por_actor_hidden_partial_shift24",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_mid_shift_probe/memory_por_switchy_actor_hidden_partial_shift24"),
        "variant": "partial_shift_0.24",
    },
    {
        "label": "por_actor_hidden_partial_shift25",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_mid_shift_probe/memory_por_switchy_actor_hidden_partial_shift25"),
...
por_shift24 = row("por_actor_hidden_partial_shift24")
...
for item in (por_base, por_shift225, por_shift24, por_shift25):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift225` | `{por_shift225['greedy/success'] - por_base['greedy/success']:+.4f}` | `{por_shift225['lower_t005/success'] - por_base['lower_t005/success']:+.4f}` | `{por_shift225['gap_t0055/success'] - por_base['gap_t0055/success']:+.4f}` | `{por_shift225['shoulder_t008/success'] - por_base['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift24` | `{por_shift24['greedy/success'] - por_base['greedy/success']:+.4f}` | `{por_shift24['lower_t005/success'] - por_base['lower_t005/success']:+.4f}` | `{por_shift24['gap_t0055/success'] - por_base['gap_t0055/success']:+.4f}` | `{por_shift24['shoulder_t008/success'] - por_base['shoulder_t008/success']:+.4f}` |",
        ...
        "| Variant | Delta Greedy | Delta Lower | Delta Gap | Delta Shoulder |",
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift225` | `{por_shift225['greedy/success'] - por_shift25['greedy/success']:+.4f}` | `{por_shift225['lower_t005/success'] - por_shift25['lower_t005/success']:+.4f}` | `{por_shift225['gap_t0055/success'] - por_shift25['gap_t0055/success']:+.4f}` | `{por_shift225['shoulder_t008/success'] - por_shift25['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift24` | `{por_shift24['greedy/success'] - por_shift25['greedy/success']:+.4f}` | `{por_shift24['lower_t005/success'] - por_shift25['lower_t005/success']:+.4f}` | `{por_shift24['gap_t0055/success'] - por_shift25['gap_t0055/success']:+.4f}` | `{por_shift24['shoulder_t008/success'] - por_shift25['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
