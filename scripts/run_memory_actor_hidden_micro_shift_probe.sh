...
ROOT="outputs/experiments/memory_actor_hidden_micro_shift_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_micro_shift_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_micro_shift_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift2225.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_micro_shift_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_micro_shift_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_micro_shift_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift_0.22",
    },
    {
        "label": "por_actor_hidden_partial_shift221",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_micro_shift_probe/memory_por_switchy_actor_hidden_partial_shift221"),
        "variant": "partial_shift_0.221",
    },
    {
        "label": "por_actor_hidden_partial_shift2225",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_micro_shift_probe/memory_por_switchy_actor_hidden_partial_shift2225"),
        "variant": "partial_shift_0.2225",
    },
]
...
por_shift2225 = row("por_actor_hidden_partial_shift2225")
...
for item in (por_base, por_shift22, por_shift221, por_shift2225):
    lines.append(
        ...
        f"`{item['train/episode_return']:.4f}` | `{item['train/success_rate']:.4f}` | `{item['policy/option_hidden_film_gate_signal_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_film_shift_weight']:.4f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift221` | `{por_shift221['greedy/success'] - por_shift22['greedy/success']:+.4f}` | `{por_shift221['lower_t005/success'] - por_shift22['lower_t005/success']:+.4f}` | `{por_shift221['gap_t0055/success'] - por_shift22['gap_t0055/success']:+.4f}` | `{por_shift221['shoulder_t008/success'] - por_shift22['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift2225` | `{por_shift2225['greedy/success'] - por_shift22['greedy/success']:+.4f}` | `{por_shift2225['lower_t005/success'] - por_shift22['lower_t005/success']:+.4f}` | `{por_shift2225['gap_t0055/success'] - por_shift22['gap_t0055/success']:+.4f}` | `{por_shift2225['shoulder_t008/success'] - por_shift22['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)

interesting = (
    (por_shift221["greedy/success"] > 0.0 and (
        por_shift221["lower_t005/success"] > por_shift22["lower_t005/success"]
        or por_shift221["gap_t0055/success"] > por_shift22["gap_t0055/success"]
        or por_shift221["shoulder_t008/success"] > por_shift22["shoulder_t008/success"]
    ))
    or (por_shift2225["greedy/success"] > 0.0 and (
        por_shift2225["lower_t005/success"] > por_shift22["lower_t005/success"]
        or por_shift2225["gap_t0055/success"] > por_shift22["gap_t0055/success"]
        or por_shift2225["shoulder_t008/success"] > por_shift22["shoulder_t008/success"]
    ))
    or por_shift221["greedy/success"] > por_shift22["greedy/success"]
    or por_shift2225["greedy/success"] > por_shift22["greedy/success"]
)

if interesting:
    lines.extend(
        [
            "- conclusion: at least one micro-shift variant preserves greedy and improves part of the sampled band, so it needs a 256-episode confirmation pass",
        ]
    )
else:
    lines.extend(
