...
OUTPUT_ROOT="${PSMN_OUTPUT_ROOT:-outputs/diagnostics/tokenization_gap}"
...
CONFIGS=(
  "configs/diagnostic/minigrid_doorkey_token_dense_baseline_probe.yaml"
  "configs/diagnostic/minigrid_doorkey_token_dense_fully_observed.yaml"
  "configs/diagnostic/minigrid_doorkey_token_dense_depth4.yaml"
  "configs/diagnostic/minigrid_doorkey_token_dense_depth4_fully_observed.yaml"
)
...
python -m psmn_rl.analysis.policy_diagnostics \
  ...
  --trace-dir outputs/reports/tokenization_gap_traces \
