...
ROOT="outputs/experiments/memory_actor_hidden_shift22_scale_up_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shift22_scale_up_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shift22_scale_up_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_scale355.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_scale36.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_shift22_scale_up_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shift22_scale_up_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shift22_scale_up_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "shift22_scale35",
    },
    {
        "label": "por_actor_hidden_partial_shift22_scale355",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shift22_scale_up_probe/memory_por_switchy_actor_hidden_partial_shift22_scale355"),
        "variant": "shift22_scale355",
    },
    {
        "label": "por_actor_hidden_partial_shift22_scale36",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shift22_scale_up_probe/memory_por_switchy_actor_hidden_partial_shift22_scale36"),
        "variant": "shift22_scale36",
    },
]
...
por_scale355 = row("por_actor_hidden_partial_shift22_scale355")
por_scale36 = row("por_actor_hidden_partial_shift22_scale36")
...
for item in (por_base, por_shift22, por_scale355, por_scale36):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift22_scale355` | `{por_scale355['greedy/success'] - por_shift22['greedy/success']:+.4f}` | `{por_scale355['lower_t005/success'] - por_shift22['lower_t005/success']:+.4f}` | `{por_scale355['gap_t0055/success'] - por_shift22['gap_t0055/success']:+.4f}` | `{por_scale355['shoulder_t008/success'] - por_shift22['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift22_scale36` | `{por_scale36['greedy/success'] - por_shift22['greedy/success']:+.4f}` | `{por_scale36['lower_t005/success'] - por_shift22['lower_t005/success']:+.4f}` | `{por_scale36['gap_t0055/success'] - por_shift22['gap_t0055/success']:+.4f}` | `{por_scale36['shoulder_t008/success'] - por_shift22['shoulder_t008/success']:+.4f}` |",
    ]
)

interesting = (
    (por_scale355["greedy/success"] > 0.0 and (
        por_scale355["lower_t005/success"] > por_shift22["lower_t005/success"]
        or por_scale355["gap_t0055/success"] > por_shift22["gap_t0055/success"]
        or por_scale355["shoulder_t008/success"] > por_shift22["shoulder_t008/success"]
    ))
    or (por_scale36["greedy/success"] > 0.0 and (
        por_scale36["lower_t005/success"] > por_shift22["lower_t005/success"]
        or por_scale36["gap_t0055/success"] > por_shift22["gap_t0055/success"]
        or por_scale36["shoulder_t008/success"] > por_shift22["shoulder_t008/success"]
    ))
    or por_scale355["greedy/success"] > por_shift22["greedy/success"]
    or por_scale36["greedy/success"] > por_shift22["greedy/success"]
)
...
if interesting:
    lines.extend(
        [
            "",
            "- conclusion: at least one scale-up variant preserves greedy and improves part of the sampled band, so it needs a 256-episode confirmation pass",
        ]
    )
else:
    lines.extend(
