...
ROOT="outputs/experiments/memory_actor_hidden_low_margin_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_low_margin_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_low_margin_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift25_low_margin35.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift25_low_margin50.yaml"
...
manifest = {
    ...
    "family": "memory_actor_hidden_low_margin_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_low_margin_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift25_low_margin35",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_low_margin_probe/memory_por_switchy_actor_hidden_partial_shift25_low_margin35"),
        "variant": "low_margin_0.35",
    },
    {
        "label": "por_actor_hidden_partial_shift25_low_margin50",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_low_margin_probe/memory_por_switchy_actor_hidden_partial_shift25_low_margin50"),
        "variant": "low_margin_0.50",
    },
    {
        "label": "por_actor_hidden_partial_shift25",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_low_margin_probe/memory_por_switchy_actor_hidden_partial_shift25"),
        "variant": "ungated",
    },
]
...
try:
    for run in RUNS:
        ...
        row: dict[str, Any] = {
            ...
            "policy/option_hidden_film_low_margin_gate": float(train_metrics.get("policy/option_hidden_film_low_margin_gate", 0.0)),
            "policy/option_hidden_film_low_margin_gate_mean": float(train_metrics.get("policy/option_hidden_film_low_margin_gate_mean", 0.0)),
            "policy/option_hidden_film_margin_before": float(train_metrics.get("policy/option_hidden_film_margin_before", 0.0)),
...
por_low35 = row("por_actor_hidden_partial_shift25_low_margin35")
por_low50 = row("por_actor_hidden_partial_shift25_low_margin50")
por_ungated = row("por_actor_hidden_partial_shift25")
...
for item in (por_base, por_low35, por_low50, por_ungated):
    lines.append(
        ...
        f"`{item['train/episode_return']:.4f}` | `{item['train/success_rate']:.4f}` | `{item['policy/option_hidden_film_low_margin_gate_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_film_margin_before']:.4f}` | `{item['policy/option_hidden_film_shift_weight']:.2f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift25_low_margin35` | `{por_low35['greedy/success'] - por_ungated['greedy/success']:+.4f}` | `{por_low35['lower_t005/success'] - por_ungated['lower_t005/success']:+.4f}` | `{por_low35['gap_t0055/success'] - por_ungated['gap_t0055/success']:+.4f}` | `{por_low35['shoulder_t008/success'] - por_ungated['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift25_low_margin50` | `{por_low50['greedy/success'] - por_ungated['greedy/success']:+.4f}` | `{por_low50['lower_t005/success'] - por_ungated['lower_t005/success']:+.4f}` | `{por_low50['gap_t0055/success'] - por_ungated['gap_t0055/success']:+.4f}` | `{por_low50['shoulder_t008/success'] - por_ungated['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
