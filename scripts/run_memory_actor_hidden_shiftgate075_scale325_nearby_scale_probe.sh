...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale325_nearby_scale_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale325_nearby_scale_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale325_nearby_scale_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale3125.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale3375.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale325_nearby_scale_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_nearby_scale_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_nearby_scale_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_nearby_scale_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shift22_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale3125",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_nearby_scale_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale3125"),
        "variant": "shift22_shiftgate075_scale3125",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale3375",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_nearby_scale_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale3375"),
        "variant": "shift22_shiftgate075_scale3375",
    },
]
...
scale325 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325")
scale3125 = row("por_actor_hidden_partial_shift22_shiftgate075_scale3125")
scale3375 = row("por_actor_hidden_partial_shift22_shiftgate075_scale3375")

lines = [
    "# Memory ShiftGate075 Scale325 Nearby-Scale Probe",
    "",
    "- hypothesis: once `shiftgate075_scale325` is alive, the best local surface may still want a slightly lower or higher hidden-FiLM scale",
...
for item in (por_base, por_shift22, scale325, scale3125, scale3375):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift22_shiftgate075_scale3125` | `{scale3125['greedy/success'] - scale325['greedy/success']:+.4f}` | `{scale3125['lower_t005/success'] - scale325['lower_t005/success']:+.4f}` | `{scale3125['gap_t0055/success'] - scale325['gap_t0055/success']:+.4f}` | `{scale3125['shoulder_t008/success'] - scale325['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift22_shiftgate075_scale3375` | `{scale3375['greedy/success'] - scale325['greedy/success']:+.4f}` | `{scale3375['lower_t005/success'] - scale325['lower_t005/success']:+.4f}` | `{scale3375['gap_t0055/success'] - scale325['gap_t0055/success']:+.4f}` | `{scale3375['shoulder_t008/success'] - scale325['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)
...
interesting = any(
    ...
    and (
        item["greedy/success"] > scale325["greedy/success"]
        or item["lower_t005/success"] > scale325["lower_t005/success"]
        or item["gap_t0055/success"] > scale325["gap_t0055/success"]
        or item["shoulder_t008/success"] > scale325["shoulder_t008/success"]
    )
    for item in (scale3125, scale3375)
)

if interesting:
    lines.append("- conclusion: at least one nearby FiLM scale preserves nonzero greedy and improves part of the restored `shiftgate075_scale325` surface; run a 256-episode confirmation pass before treating it as real")
else:
    lines.append("- conclusion: nearby FiLM scale retuning around `shiftgate075_scale325` does not improve the restored local surface")
