...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale325_branch_gate_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale325_branch_gate_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale325_branch_gate_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_shiftmix95.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_shiftmix90.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale325_branch_gate_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_branch_gate_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_branch_gate_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_branch_gate_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shift22_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftmix95",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_branch_gate_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_shiftmix95"),
        "variant": "shift22_shiftgate075_scale325_shiftmix95",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftmix90",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_branch_gate_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_shiftmix90"),
        "variant": "shift22_shiftgate075_scale325_shiftmix90",
    },
]
...
shiftmix95 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftmix95")
shiftmix90 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftmix90")

lines = [
    "# Memory ShiftGate075 Scale325 Branch-Gate Probe",
    "",
    "- hypothesis: the current `shiftgate075_scale325` winner may benefit from keeping scale on raw duration while mixing only the additive shift branch slightly toward stability",
...
for item in (por_base, por_shift22, incumbent, shiftmix95, shiftmix90):
    lines.append(
        ...
        f"`{item['policy/option_hidden_scale_gate_signal_mean']:.4f}` | `{item['policy/option_hidden_shift_gate_signal_mean']:.4f}` | "
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftmix95` | `{shiftmix95['greedy/success'] - incumbent['greedy/success']:+.4f}` | `{shiftmix95['lower_t005/success'] - incumbent['lower_t005/success']:+.4f}` | `{shiftmix95['gap_t0055/success'] - incumbent['gap_t0055/success']:+.4f}` | `{shiftmix95['shoulder_t008/success'] - incumbent['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftmix90` | `{shiftmix90['greedy/success'] - incumbent['greedy/success']:+.4f}` | `{shiftmix90['lower_t005/success'] - incumbent['lower_t005/success']:+.4f}` | `{shiftmix90['gap_t0055/success'] - incumbent['gap_t0055/success']:+.4f}` | `{shiftmix90['shoulder_t008/success'] - incumbent['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)
...
interesting = any(
    ...
    for item in (shiftmix95, shiftmix90)
)

if interesting:
    lines.append("- conclusion: at least one branch-specific shift-gate mix preserves nonzero greedy and improves part of the restored `shiftgate075_scale325` surface; run a 256-episode confirmation pass before treating it as real")
else:
    lines.append("- conclusion: branch-specific shift-gate mixing around `shiftgate075_scale325` does not improve the restored local surface")
