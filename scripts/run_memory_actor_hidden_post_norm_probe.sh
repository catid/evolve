...
ROOT="outputs/experiments/memory_actor_hidden_post_norm_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_post_norm_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_post_norm_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift25_scale325_post_norm.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift25_post_norm.yaml"
...
manifest = {
    ...
    "family": "memory_actor_hidden_post_norm_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_post_norm_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift25_scale325_post_norm",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_post_norm_probe/memory_por_switchy_actor_hidden_partial_shift25_scale325_post_norm"),
        "variant": "shift25_scale325_post_norm",
    },
    {
        "label": "por_actor_hidden_partial_shift25_post_norm",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_post_norm_probe/memory_por_switchy_actor_hidden_partial_shift25_post_norm"),
        "variant": "shift25_scale35_post_norm",
    },
    {
        "label": "por_actor_hidden_partial_shift25",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_post_norm_probe/memory_por_switchy_actor_hidden_partial_shift25"),
        "variant": "shift25_scale35",
    },
]
...
try:
    for run in RUNS:
        ...
        row: dict[str, Any] = {
            ...
            "policy/option_hidden_post_norm": float(train_metrics.get("policy/option_hidden_post_norm", 0.0)),
            ...
            "policy/option_hidden_post_hidden_norm": float(train_metrics.get("policy/option_hidden_post_hidden_norm", 0.0)),
        }
...
por_scale325_post_norm = row("por_actor_hidden_partial_shift25_scale325_post_norm")
por_post_norm = row("por_actor_hidden_partial_shift25_post_norm")
por_scale35 = row("por_actor_hidden_partial_shift25")
...
for item in (por_base, por_scale325_post_norm, por_post_norm, por_scale35):
    lines.append(
        ...
        f"`{item['train/episode_return']:.4f}` | `{item['train/success_rate']:.4f}` | `{item['policy/option_hidden_post_norm']:.0f}` | `{item['policy/option_hidden_film_gate_signal_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_post_hidden_norm']:.4f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift25_post_norm` | `{por_post_norm['greedy/success'] - por_scale35['greedy/success']:+.4f}` | `{por_post_norm['lower_t005/success'] - por_scale35['lower_t005/success']:+.4f}` | `{por_post_norm['gap_t0055/success'] - por_scale35['gap_t0055/success']:+.4f}` | `{por_post_norm['shoulder_t008/success'] - por_scale35['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift25_scale325_post_norm` | `{por_scale325_post_norm['greedy/success'] - por_scale35['greedy/success']:+.4f}` | `{por_scale325_post_norm['lower_t005/success'] - por_scale35['lower_t005/success']:+.4f}` | `{por_scale325_post_norm['gap_t0055/success'] - por_scale35['gap_t0055/success']:+.4f}` | `{por_scale325_post_norm['shoulder_t008/success'] - por_scale35['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
