...
ROOT="outputs/experiments/memory_actor_hidden_scale_followup_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_scale_followup_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_scale_followup_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225_scale375.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225_scale40.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_scale_followup_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_followup_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift225",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_followup_probe/memory_por_switchy_actor_hidden_partial_shift225"),
        "variant": "shift225_scale35",
    },
    {
        "label": "por_actor_hidden_partial_shift225_scale375",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_followup_probe/memory_por_switchy_actor_hidden_partial_shift225_scale375"),
        "variant": "shift225_scale375",
    },
    {
        "label": "por_actor_hidden_partial_shift225_scale40",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_followup_probe/memory_por_switchy_actor_hidden_partial_shift225_scale40"),
        "variant": "shift225_scale40",
    },
]
...
por_scale375 = row("por_actor_hidden_partial_shift225_scale375")
por_scale40 = row("por_actor_hidden_partial_shift225_scale40")
...
for item in (por_base, por_shift225, por_scale375, por_scale40):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift225_scale375` | `{por_scale375['greedy/success'] - por_shift225['greedy/success']:+.4f}` | `{por_scale375['lower_t005/success'] - por_shift225['lower_t005/success']:+.4f}` | `{por_scale375['gap_t0055/success'] - por_shift225['gap_t0055/success']:+.4f}` | `{por_scale375['shoulder_t008/success'] - por_shift225['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift225_scale40` | `{por_scale40['greedy/success'] - por_shift225['greedy/success']:+.4f}` | `{por_scale40['lower_t005/success'] - por_shift225['lower_t005/success']:+.4f}` | `{por_scale40['gap_t0055/success'] - por_shift225['gap_t0055/success']:+.4f}` | `{por_scale40['shoulder_t008/success'] - por_shift225['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
