...
ROOT="outputs/experiments/memory_actor_hidden_threshold_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_threshold_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_threshold_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift215.yaml"
...
manifest = {
    ...
    "family": "memory_actor_hidden_threshold_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_threshold_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift225",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_threshold_probe/memory_por_switchy_actor_hidden_partial_shift225"),
        "variant": "partial_shift_0.225",
    },
    {
        "label": "por_actor_hidden_partial_shift215",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_threshold_probe/memory_por_switchy_actor_hidden_partial_shift215"),
        "variant": "partial_shift_0.215",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_threshold_probe/memory_por_switchy_actor_hidden_partial_shift22"),
...
por_shift215 = row("por_actor_hidden_partial_shift215")
...
for item in (por_base, por_shift225, por_shift215, por_shift22):
    lines.append(
        ...
        f"`{item['train/episode_return']:.4f}` | `{item['train/success_rate']:.4f}` | `{item['policy/option_hidden_film_gate_signal_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_film_shift_weight']:.3f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift215` | `{por_shift215['greedy/success'] - por_shift225['greedy/success']:+.4f}` | `{por_shift215['lower_t005/success'] - por_shift225['lower_t005/success']:+.4f}` | `{por_shift215['gap_t0055/success'] - por_shift225['gap_t0055/success']:+.4f}` | `{por_shift215['shoulder_t008/success'] - por_shift225['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift22` | `{por_shift22['greedy/success'] - por_shift225['greedy/success']:+.4f}` | `{por_shift22['lower_t005/success'] - por_shift225['lower_t005/success']:+.4f}` | `{por_shift22['gap_t0055/success'] - por_shift225['gap_t0055/success']:+.4f}` | `{por_shift22['shoulder_t008/success'] - por_shift225['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)

interesting = (
    por_shift215["greedy/success"] > 0.0
    or por_shift22["greedy/success"] > 0.0
    or por_shift215["lower_t005/success"] > por_shift225["lower_t005/success"]
    or por_shift215["gap_t0055/success"] > por_shift225["gap_t0055/success"]
    or por_shift215["shoulder_t008/success"] > por_shift225["shoulder_t008/success"]
    or por_shift22["lower_t005/success"] > por_shift225["lower_t005/success"]
    or por_shift22["gap_t0055/success"] > por_shift225["gap_t0055/success"]
    or por_shift22["shoulder_t008/success"] > por_shift225["shoulder_t008/success"]
)
...
if interesting:
    ...
    lines.extend(
        [
            "- conclusion: neither midpoint improves on `partial_shift225`; the greedy-conversion threshold is already tight at the current best-known point",
        ]
    )
