...
ROOT="outputs/experiments/memory_actor_hidden_lower_shift_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_lower_shift_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_lower_shift_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift15.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift20.yaml"
...
manifest = {
    ...
    "family": "memory_actor_hidden_lower_shift_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_lower_shift_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift15",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_lower_shift_probe/memory_por_switchy_actor_hidden_partial_shift15"),
        "variant": "partial_shift_0.15",
    },
    {
        "label": "por_actor_hidden_partial_shift20",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_lower_shift_probe/memory_por_switchy_actor_hidden_partial_shift20"),
        "variant": "partial_shift_0.20",
    },
    {
        "label": "por_actor_hidden_partial_shift25",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_lower_shift_probe/memory_por_switchy_actor_hidden_partial_shift25"),
...
por_shift15 = row("por_actor_hidden_partial_shift15")
por_shift20 = row("por_actor_hidden_partial_shift20")
...
for item in (por_base, por_shift15, por_shift20, por_shift25):
    lines.append(
        ...
        f"`{item['train/episode_return']:.4f}` | `{item['train/success_rate']:.4f}` | `{item['policy/option_hidden_film_gate_signal_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_film_shift_weight']:.2f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift15` | `{por_shift15['greedy/success'] - por_base['greedy/success']:+.4f}` | `{por_shift15['lower_t005/success'] - por_base['lower_t005/success']:+.4f}` | `{por_shift15['gap_t0055/success'] - por_base['gap_t0055/success']:+.4f}` | `{por_shift15['shoulder_t008/success'] - por_base['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift20` | `{por_shift20['greedy/success'] - por_base['greedy/success']:+.4f}` | `{por_shift20['lower_t005/success'] - por_base['lower_t005/success']:+.4f}` | `{por_shift20['gap_t0055/success'] - por_base['gap_t0055/success']:+.4f}` | `{por_shift20['shoulder_t008/success'] - por_base['shoulder_t008/success']:+.4f}` |",
        ...
        "| Variant | Delta Greedy | Delta Lower | Delta Gap | Delta Shoulder |",
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift15` | `{por_shift15['greedy/success'] - por_shift25['greedy/success']:+.4f}` | `{por_shift15['lower_t005/success'] - por_shift25['lower_t005/success']:+.4f}` | `{por_shift15['gap_t0055/success'] - por_shift25['gap_t0055/success']:+.4f}` | `{por_shift15['shoulder_t008/success'] - por_shift25['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift20` | `{por_shift20['greedy/success'] - por_shift25['greedy/success']:+.4f}` | `{por_shift20['lower_t005/success'] - por_shift25['lower_t005/success']:+.4f}` | `{por_shift20['gap_t0055/success'] - por_shift25['gap_t0055/success']:+.4f}` | `{por_shift20['shoulder_t008/success'] - por_shift25['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
