...
ROOT="outputs/experiments/memory_actor_hidden_blend_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_blend_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_blend_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift25_blend100.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift25_blend150.yaml"
...
manifest = {
    ...
    "family": "memory_actor_hidden_blend_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_blend_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift25_blend100",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_blend_probe/memory_por_switchy_actor_hidden_partial_shift25_blend100"),
        "variant": "blend_1.00",
    },
    {
        "label": "por_actor_hidden_partial_shift25_blend150",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_blend_probe/memory_por_switchy_actor_hidden_partial_shift25_blend150"),
        "variant": "blend_1.50",
    },
    {
        "label": "por_actor_hidden_partial_shift25",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_blend_probe/memory_por_switchy_actor_hidden_partial_shift25"),
        "variant": "ungated",
    },
]
...
try:
    for run in RUNS:
        ...
        row: dict[str, Any] = {
            ...
            "policy/option_hidden_blend_gate": float(train_metrics.get("policy/option_hidden_blend_gate", 0.0)),
            "policy/option_hidden_blend_scale": float(train_metrics.get("policy/option_hidden_blend_scale", 0.0)),
            "policy/option_hidden_blend_gate_mean": float(train_metrics.get("policy/option_hidden_blend_gate_mean", 0.0)),
...
por_blend100 = row("por_actor_hidden_partial_shift25_blend100")
por_blend150 = row("por_actor_hidden_partial_shift25_blend150")
...
for item in (por_base, por_blend100, por_blend150, por_ungated):
    lines.append(
        ...
        f"`{item['train/episode_return']:.4f}` | `{item['train/success_rate']:.4f}` | `{item['policy/option_hidden_blend_gate']:.0f}` | `{item['policy/option_hidden_blend_scale']:.2f}` | `{item['policy/option_hidden_blend_gate_mean']:.4f}` | `{item['policy/option_hidden_film_gate_signal_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift25_blend100` | `{por_blend100['greedy/success'] - por_ungated['greedy/success']:+.4f}` | `{por_blend100['lower_t005/success'] - por_ungated['lower_t005/success']:+.4f}` | `{por_blend100['gap_t0055/success'] - por_ungated['gap_t0055/success']:+.4f}` | `{por_blend100['shoulder_t008/success'] - por_ungated['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift25_blend150` | `{por_blend150['greedy/success'] - por_ungated['greedy/success']:+.4f}` | `{por_blend150['lower_t005/success'] - por_ungated['lower_t005/success']:+.4f}` | `{por_blend150['gap_t0055/success'] - por_ungated['gap_t0055/success']:+.4f}` | `{por_blend150['shoulder_t008/success'] - por_ungated['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
