...
OUTPUT_PATH="${PSMN_REPORT_OUTPUT:-outputs/reports/lss_forensic_atlas_reproduction_note.md}"
CSV_PATH="${PSMN_REPORT_CSV:-outputs/reports/lss_forensic_atlas_reproduction_note.csv}"
