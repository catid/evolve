...
ROOT="outputs/experiments/memory_actor_hidden_scale_branch_gate_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_scale_branch_gate_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_scale_branch_gate_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_scalemix95.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_scalemix90.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_scale_branch_gate_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_branch_gate_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_branch_gate_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift_0.22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_scalemix95",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_branch_gate_probe/memory_por_switchy_actor_hidden_partial_shift22_scalemix95"),
        "variant": "scale_mix_0.95",
    },
    {
        "label": "por_actor_hidden_partial_shift22_scalemix90",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_branch_gate_probe/memory_por_switchy_actor_hidden_partial_shift22_scalemix90"),
        "variant": "scale_mix_0.90",
    },
]
...
por_scalemix95 = row("por_actor_hidden_partial_shift22_scalemix95")
por_scalemix90 = row("por_actor_hidden_partial_shift22_scalemix90")
...
for item in (por_base, por_shift22, por_scalemix95, por_scalemix90):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift22_scalemix95` | `{por_scalemix95['greedy/success'] - por_shift22['greedy/success']:+.4f}` | `{por_scalemix95['lower_t005/success'] - por_shift22['lower_t005/success']:+.4f}` | `{por_scalemix95['gap_t0055/success'] - por_shift22['gap_t0055/success']:+.4f}` | `{por_scalemix95['shoulder_t008/success'] - por_shift22['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift22_scalemix90` | `{por_scalemix90['greedy/success'] - por_shift22['greedy/success']:+.4f}` | `{por_scalemix90['lower_t005/success'] - por_shift22['lower_t005/success']:+.4f}` | `{por_scalemix90['gap_t0055/success'] - por_shift22['gap_t0055/success']:+.4f}` | `{por_scalemix90['shoulder_t008/success'] - por_shift22['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)

interesting = (
    (por_scalemix95["greedy/success"] > 0.0 and (
        por_scalemix95["lower_t005/success"] > por_shift22["lower_t005/success"]
        or por_scalemix95["gap_t0055/success"] > por_shift22["gap_t0055/success"]
        or por_scalemix95["shoulder_t008/success"] > por_shift22["shoulder_t008/success"]
    ))
    or (por_scalemix90["greedy/success"] > 0.0 and (
        por_scalemix90["lower_t005/success"] > por_shift22["lower_t005/success"]
        or por_scalemix90["gap_t0055/success"] > por_shift22["gap_t0055/success"]
        or por_scalemix90["shoulder_t008/success"] > por_shift22["shoulder_t008/success"]
    ))
)
...
if interesting:
    lines.extend(
        [
            "## Outcome",
            "",
            "At least one scale-branch-only gate mix preserved nonzero greedy conversion while improving part of the sampled band over `partial_shift22`, so this surface should get a longer confirmation pass before being accepted or rejected.",
        ]
    )
else:
    lines.extend(
