...
ROOT="outputs/experiments/memory_actor_hidden_split_scale_weight_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_split_scale_weight_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_split_scale_weight_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift25_scaleweight50.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift25_scaleweight75.yaml"
...
manifest = {
    ...
    "family": "memory_actor_hidden_split_scale_weight_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_split_scale_weight_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift25_scaleweight50",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_split_scale_weight_probe/memory_por_switchy_actor_hidden_partial_shift25_scaleweight50"),
        "variant": "scale_weight_0.50",
    },
    {
        "label": "por_actor_hidden_partial_shift25_scaleweight75",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_split_scale_weight_probe/memory_por_switchy_actor_hidden_partial_shift25_scaleweight75"),
        "variant": "scale_weight_0.75",
    },
    {
        "label": "por_actor_hidden_partial_shift25",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_split_scale_weight_probe/memory_por_switchy_actor_hidden_partial_shift25"),
...
por_scale50 = row("por_actor_hidden_partial_shift25_scaleweight50")
por_scale75 = row("por_actor_hidden_partial_shift25_scaleweight75")
por_scale100 = row("por_actor_hidden_partial_shift25")
...
for item in (por_base, por_scale50, por_scale75, por_scale100):
    lines.append(
        ...
        f"`{item['train/episode_return']:.4f}` | `{item['train/success_rate']:.4f}` | `{item['policy/option_hidden_film_gate_signal_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_film_scale_weight']:.2f}` | `{item['policy/option_hidden_film_shift_weight']:.2f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift25_scaleweight50` | `{por_scale50['greedy/success'] - por_scale100['greedy/success']:+.4f}` | `{por_scale50['lower_t005/success'] - por_scale100['lower_t005/success']:+.4f}` | `{por_scale50['gap_t0055/success'] - por_scale100['gap_t0055/success']:+.4f}` | `{por_scale50['shoulder_t008/success'] - por_scale100['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift25_scaleweight75` | `{por_scale75['greedy/success'] - por_scale100['greedy/success']:+.4f}` | `{por_scale75['lower_t005/success'] - por_scale100['lower_t005/success']:+.4f}` | `{por_scale75['gap_t0055/success'] - por_scale100['gap_t0055/success']:+.4f}` | `{por_scale75['shoulder_t008/success'] - por_scale100['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
