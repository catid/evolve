...
OUTPUT_PATH="${PSMN_REPORT_OUTPUT:-outputs/reports/lss_forensic_route_locality.md}"
CSV_PATH="${PSMN_REPORT_CSV:-outputs/reports/lss_forensic_route_locality.csv}"
...
source .venv/bin/activate
eval "${ANALYSIS_LAUNCHER} route-locality \
