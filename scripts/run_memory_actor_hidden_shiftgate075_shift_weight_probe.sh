...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_shift_weight_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_shift_weight_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_shift_weight_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift215_shiftgate075.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225_shiftgate075.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_shift_weight_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_shift_weight_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_shift_weight_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_shift_weight_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075"),
        "variant": "shift22_shiftgate075",
    },
    {
        "label": "por_actor_hidden_partial_shift215_shiftgate075",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_shift_weight_probe/memory_por_switchy_actor_hidden_partial_shift215_shiftgate075"),
        "variant": "shift215_shiftgate075",
    },
    {
        "label": "por_actor_hidden_partial_shift225_shiftgate075",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_shift_weight_probe/memory_por_switchy_actor_hidden_partial_shift225_shiftgate075"),
        "variant": "shift225_shiftgate075",
    },
]
...
shift22 = row("por_actor_hidden_partial_shift22_shiftgate075")
shift215 = row("por_actor_hidden_partial_shift215_shiftgate075")
shift225 = row("por_actor_hidden_partial_shift225_shiftgate075")

lines = [
    "# Memory ShiftGate075 Shift-Weight Probe",
    "",
    "- hypothesis: once the additive gate is mildly softened, the surviving local surface may want a nearby hidden shift weight rather than the original `0.22` threshold",
...
for item in (por_base, por_shift22, shift22, shift215, shift225):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift215_shiftgate075` | `{shift215['greedy/success'] - shift22['greedy/success']:+.4f}` | `{shift215['lower_t005/success'] - shift22['lower_t005/success']:+.4f}` | `{shift215['gap_t0055/success'] - shift22['gap_t0055/success']:+.4f}` | `{shift215['shoulder_t008/success'] - shift22['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift225_shiftgate075` | `{shift225['greedy/success'] - shift22['greedy/success']:+.4f}` | `{shift225['lower_t005/success'] - shift22['lower_t005/success']:+.4f}` | `{shift225['gap_t0055/success'] - shift22['gap_t0055/success']:+.4f}` | `{shift225['shoulder_t008/success'] - shift22['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)
...
interesting = any(
    ...
    and (
        item["greedy/success"] > shift22["greedy/success"]
        or item["lower_t005/success"] > shift22["lower_t005/success"]
        or item["gap_t0055/success"] > shift22["gap_t0055/success"]
        or item["shoulder_t008/success"] > shift22["shoulder_t008/success"]
    )
    for item in (shift215, shift225)
)

if interesting:
    lines.append("- conclusion: at least one shift-weight refinement preserves nonzero greedy and improves part of the restored `shiftgate075` surface; run a 256-episode confirmation pass before treating it as real")
else:
    lines.append("- conclusion: retuning hidden shift weight around `shiftgate075` does not improve the restored local surface")
