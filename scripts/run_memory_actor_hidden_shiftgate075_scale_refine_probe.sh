...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale_refine_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale_refine_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale_refine_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale375.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale_refine_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale_refine_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale_refine_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale_refine_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075"),
        "variant": "shiftgate075",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale_refine_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale375",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale_refine_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale375"),
        "variant": "shiftgate075_scale375",
    },
]
...
scale375 = row("por_actor_hidden_partial_shift22_shiftgate075_scale375")

lines = [
    "# Memory ShiftGate075 Scale-Refine Probe",
    "",
    "- hypothesis: the restored `shiftgate075` local surface may want a slightly different hidden-FiLM scale than the current `0.35`",
...
for item in (por_base, por_shift22, shift075, scale325, scale375):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift22_shiftgate075_scale325` | `{scale325['greedy/success'] - shift075['greedy/success']:+.4f}` | `{scale325['lower_t005/success'] - shift075['lower_t005/success']:+.4f}` | `{scale325['gap_t0055/success'] - shift075['gap_t0055/success']:+.4f}` | `{scale325['shoulder_t008/success'] - shift075['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift22_shiftgate075_scale375` | `{scale375['greedy/success'] - shift075['greedy/success']:+.4f}` | `{scale375['lower_t005/success'] - shift075['lower_t005/success']:+.4f}` | `{scale375['gap_t0055/success'] - shift075['gap_t0055/success']:+.4f}` | `{scale375['shoulder_t008/success'] - shift075['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)
...
interesting = any(
    ...
    for item in (scale325, scale375)
)

if interesting:
    lines.append("- conclusion: at least one nearby FiLM scale preserves nonzero greedy and improves part of the restored `shiftgate075` surface; run a 256-episode confirmation pass before treating it as real")
else:
    lines.append("- conclusion: retuning FiLM scale around `shiftgate075` does not improve the restored local surface")
