...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_comp_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale325_shift_comp_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale325_shift_comp_probe.json"
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale325_shift_comp_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_comp_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_comp_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_comp_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shift22_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_adaptive_floor2875",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_comp_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_adaptive_floor2875"),
        "variant": "shift22_shiftgate075_scale325_adaptive_floor2875",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_adaptive_floor2875_shiftcomp100",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_comp_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_adaptive_floor2875_shiftcomp100"),
        "variant": "shift22_shiftgate075_scale325_adaptive_floor2875_shiftcomp100",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_adaptive_floor2875_shiftcomp200",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_comp_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_adaptive_floor2875_shiftcomp200"),
        "variant": "shift22_shiftgate075_scale325_adaptive_floor2875_shiftcomp200",
    },
]
...
try:
    for run in RUNS:
        ...
        row: dict[str, Any] = {
            ...
            "policy/option_hidden_shift_compensation_mean": float(train_metrics.get("policy/option_hidden_shift_compensation_mean", 0.0)),
            "policy/option_hidden_shift_compensation": float(train_metrics.get("policy/option_hidden_shift_compensation", 0.0)),
            "policy/option_hidden_shift_compensation_scale": float(train_metrics.get("policy/option_hidden_shift_compensation_scale", 0.0)),
            "policy/option_hidden_scale_floor": float(train_metrics.get("policy/option_hidden_scale_floor", 0.0)),
...
floor2875 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_adaptive_floor2875")
comp100 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_adaptive_floor2875_shiftcomp100")
comp200 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_adaptive_floor2875_shiftcomp200")
...
for item in (por_base, shift22, winner, floor2875, comp100, comp200):
    lines.append(
        ...
        f"`{item['policy/option_hidden_adaptive_scale_mean']:.4f}` | `{item['policy/option_hidden_shift_compensation_mean']:.4f}` | "
        f"`{item['policy/option_hidden_shift_compensation']:.0f}` | `{item['policy/option_hidden_shift_compensation_scale']:.2f}` | "
        f"`{item['policy/option_hidden_scale_floor']:.4f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "",
        f"- `shiftcomp100`: greedy {comp100['greedy/success'] - floor2875['greedy/success']:+.4f}, lower {comp100['lower_t005/success'] - floor2875['lower_t005/success']:+.4f}, gap {comp100['gap_t0055/success'] - floor2875['gap_t0055/success']:+.4f}, shoulder {comp100['shoulder_t008/success'] - floor2875['shoulder_t008/success']:+.4f}",
        f"- `shiftcomp200`: greedy {comp200['greedy/success'] - floor2875['greedy/success']:+.4f}, lower {comp200['lower_t005/success'] - floor2875['lower_t005/success']:+.4f}, gap {comp200['gap_t0055/success'] - floor2875['gap_t0055/success']:+.4f}, shoulder {comp200['shoulder_t008/success'] - floor2875['shoulder_t008/success']:+.4f}",
        "",
        "## Conclusion",
        "",
    ]
...
interesting = any(
    item["greedy/success"] > floor2875["greedy/success"]
    and item["lower_t005/success"] >= floor2875["lower_t005/success"]
    and item["gap_t0055/success"] >= floor2875["gap_t0055/success"]
    and item["shoulder_t008/success"] >= floor2875["shoulder_t008/success"]
    for item in (comp100, comp200)
)

if interesting:
    lines.append("- at least one compensated `adaptive_floor2875` variant improves the full greedy/sample surface over the uncompensated floor; run a 256-episode confirmation pass before treating it as real")
else:
    lines.append("- stronger shift compensation does not improve on `adaptive_floor2875`; this mild scale-floor branch is not fixed by simply boosting the additive hidden shift")
