...
ROOT="outputs/diagnostics/architecture_route_bias_keyed_residual_predictive_base_delta_mix_probe"
REPORT_MD="outputs/reports/architecture_route_bias_keyed_residual_predictive_base_delta_mix_probe.md"
REPORT_JSON="outputs/reports/architecture_route_bias_keyed_residual_predictive_base_delta_mix_probe.json"
RUN_SUMMARY_MD="outputs/reports/architecture_route_bias_keyed_residual_predictive_base_delta_mix_probe_run_summary.md"
RUN_SUMMARY_CSV="outputs/reports/architecture_route_bias_keyed_residual_predictive_base_delta_mix_probe_run_summary.csv"
...
declare -a CONFIGS=(
  ...
  "configs/diagnostic/minigrid_doorkey_sare_phase_memory_route_bias_keyed_residual_predictive_base_delta_mix_probe.yaml"
)
...
manifest = {
    ...
    "family": "architecture_route_bias_keyed_residual_predictive_base_delta_mix_probe",
...
for metrics_path in sorted(root.glob("*/metrics.jsonl")):
    ...
    if "sare_phase_memory_route_bias_keyed_residual_predictive_base_delta_mix" in config_text:
...
variants = {
    ...
    "sare_phase_memory_route_bias_keyed_residual_predictive_base_delta_mix": summarize("sare_phase_memory_route_bias_keyed_residual_predictive_base_delta_mix"),
}

report_json.write_text(json.dumps({"runs": rows, "summary": variants}, indent=2, sort_keys=True), encoding="utf-8")

lines = [
    "# Predictive Base Delta-Mix Keyed-Residual Route-Bias Probe",
    "",
    "| Variant | Runs | Eval Success | Eval Return | Train Success | Throughput | Route Entropy | Route Bias Norm | Base Logits Norm | Predictive Base Logits Norm | Final Keyed Norm | Predictive Base Delta Norm | Mixed Predictive Base Delta Norm | Total Logits Norm | Predictive Hidden Norm |",
    "| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |",
]
