...
ROOT="outputs/experiments/memory_actor_hidden_adaptive_shift_comp_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_adaptive_shift_comp_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_adaptive_shift_comp_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_adaptive_floor25_shiftcomp100.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_adaptive_shift_comp_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {"label": "por_base", "run_dir": Path("outputs/experiments/memory_actor_hidden_adaptive_shift_comp_probe/memory_por_switchy_rerun")},
    {"label": "por_actor_hidden_partial_shift22", "run_dir": Path("outputs/experiments/memory_actor_hidden_adaptive_shift_comp_probe/memory_por_switchy_actor_hidden_partial_shift22")},
    {"label": "por_actor_hidden_partial_shift22_adaptive_floor25", "run_dir": Path("outputs/experiments/memory_actor_hidden_adaptive_shift_comp_probe/memory_por_switchy_actor_hidden_partial_shift22_adaptive_floor25")},
    {"label": "por_actor_hidden_partial_shift22_adaptive_floor25_shiftcomp50", "run_dir": Path("outputs/experiments/memory_actor_hidden_adaptive_shift_comp_probe/memory_por_switchy_actor_hidden_partial_shift22_adaptive_floor25_shiftcomp50")},
    {"label": "por_actor_hidden_partial_shift22_adaptive_floor25_shiftcomp100", "run_dir": Path("outputs/experiments/memory_actor_hidden_adaptive_shift_comp_probe/memory_por_switchy_actor_hidden_partial_shift22_adaptive_floor25_shiftcomp100")},
]
...
por_comp50 = row("por_actor_hidden_partial_shift22_adaptive_floor25_shiftcomp50")
por_comp100 = row("por_actor_hidden_partial_shift22_adaptive_floor25_shiftcomp100")
...
for item in (por_base, por_shift22, por_floor25, por_comp50, por_comp100):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift22_adaptive_floor25_shiftcomp50` | `{por_comp50['greedy/success'] - por_floor25['greedy/success']:+.4f}` | `{por_comp50['lower_t005/success'] - por_floor25['lower_t005/success']:+.4f}` | `{por_comp50['gap_t0055/success'] - por_floor25['gap_t0055/success']:+.4f}` | `{por_comp50['shoulder_t008/success'] - por_floor25['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift22_adaptive_floor25_shiftcomp100` | `{por_comp100['greedy/success'] - por_floor25['greedy/success']:+.4f}` | `{por_comp100['lower_t005/success'] - por_floor25['lower_t005/success']:+.4f}` | `{por_comp100['gap_t0055/success'] - por_floor25['gap_t0055/success']:+.4f}` | `{por_comp100['shoulder_t008/success'] - por_floor25['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)

interesting = any(
    item["greedy/success"] > por_floor25["greedy/success"]
    and (
        item["lower_t005/success"] >= por_floor25["lower_t005/success"]
        or item["gap_t0055/success"] >= por_floor25["gap_t0055/success"]
        or item["shoulder_t008/success"] >= por_floor25["shoulder_t008/success"]
    )
    for item in (por_comp50, por_comp100)
)

if interesting:
    lines.append("- conclusion: at least one shift-compensated adaptive-floor variant improves the greedy/sample trade-off over `adaptive_floor25`; run a 256-episode confirmation pass before treating it as real")
else:
    lines.append("- conclusion: shift compensation does not improve on `adaptive_floor25`; the current adaptive-floor trade-off is not fixed by simply boosting the additive hidden shift")
