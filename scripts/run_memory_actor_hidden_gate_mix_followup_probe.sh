...
ROOT="outputs/experiments/memory_actor_hidden_gate_mix_followup_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_gate_mix_followup_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_gate_mix_followup_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225_mix90.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225_mix95.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_gate_mix_followup_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_gate_mix_followup_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift225",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_gate_mix_followup_probe/memory_por_switchy_actor_hidden_partial_shift225"),
        "variant": "duration_mix_1.00",
    },
    {
        "label": "por_actor_hidden_partial_shift225_mix90",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_gate_mix_followup_probe/memory_por_switchy_actor_hidden_partial_shift225_mix90"),
        "variant": "duration_mix_0.90",
    },
    {
        "label": "por_actor_hidden_partial_shift225_mix95",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_gate_mix_followup_probe/memory_por_switchy_actor_hidden_partial_shift225_mix95"),
        "variant": "duration_mix_0.95",
    },
]
...
try:
    for run in RUNS:
        ...
        row: dict[str, Any] = {
            ...
            "policy/option_hidden_film_duration_mix": float(train_metrics.get("policy/option_hidden_film_duration_mix", 1.0)),
...
por_mix100 = row("por_actor_hidden_partial_shift225")
por_mix90 = row("por_actor_hidden_partial_shift225_mix90")
por_mix95 = row("por_actor_hidden_partial_shift225_mix95")
...
for item in (por_base, por_mix100, por_mix90, por_mix95):
    lines.append(
        ...
        f"`{item['train/episode_return']:.4f}` | `{item['train/success_rate']:.4f}` | `{item['policy/option_hidden_film_gate_signal_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_film_duration_mix']:.2f}` | `{item['policy/option_hidden_film_shift_weight']:.3f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift225_mix90` | `{por_mix90['greedy/success'] - por_mix100['greedy/success']:+.4f}` | `{por_mix90['lower_t005/success'] - por_mix100['lower_t005/success']:+.4f}` | `{por_mix90['gap_t0055/success'] - por_mix100['gap_t0055/success']:+.4f}` | `{por_mix90['shoulder_t008/success'] - por_mix100['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift225_mix95` | `{por_mix95['greedy/success'] - por_mix100['greedy/success']:+.4f}` | `{por_mix95['lower_t005/success'] - por_mix100['lower_t005/success']:+.4f}` | `{por_mix95['gap_t0055/success'] - por_mix100['gap_t0055/success']:+.4f}` | `{por_mix95['shoulder_t008/success'] - por_mix100['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
