...
ROOT="outputs/experiments/memory_actor_hidden_low_scale_followup_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_low_scale_followup_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_low_scale_followup_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225_scale325.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225_scale30.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_low_scale_followup_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_low_scale_followup_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift225",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_low_scale_followup_probe/memory_por_switchy_actor_hidden_partial_shift225"),
        "variant": "shift225_scale35",
    },
    {
        "label": "por_actor_hidden_partial_shift225_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_low_scale_followup_probe/memory_por_switchy_actor_hidden_partial_shift225_scale325"),
        "variant": "shift225_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift225_scale30",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_low_scale_followup_probe/memory_por_switchy_actor_hidden_partial_shift225_scale30"),
        "variant": "shift225_scale30",
    },
]
...
por_shift225 = row("por_actor_hidden_partial_shift225")
por_scale325 = row("por_actor_hidden_partial_shift225_scale325")
por_scale30 = row("por_actor_hidden_partial_shift225_scale30")
...
for item in (por_base, por_shift225, por_scale325, por_scale30):
    lines.append(
        ...
        f"`{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_film_shift_weight']:.4f}` | "
...
lines.extend(
    [
        ...
        "## Interpretation",
        "",
        f"- incumbent `partial_shift225` remains the reference greedy-conversion point at `{por_shift225['greedy/success']:.4f}` greedy with sampled `{por_shift225['lower_t005/success']:.4f} / {por_shift225['gap_t0055/success']:.4f} / {por_shift225['shoulder_t008/success']:.4f}`",
        f"- `scale325` changes the same surface to `{por_scale325['greedy/success']:.4f} / {por_scale325['lower_t005/success']:.4f} / {por_scale325['gap_t0055/success']:.4f} / {por_scale325['shoulder_t008/success']:.4f}` on greedy/lower/gap/shoulder",
        f"- `scale30` changes the same surface to `{por_scale30['greedy/success']:.4f} / {por_scale30['lower_t005/success']:.4f} / {por_scale30['gap_t0055/success']:.4f} / {por_scale30['shoulder_t008/success']:.4f}` on greedy/lower/gap/shoulder",
    ]
)

if (
    por_scale325["greedy/success"] > por_shift225["greedy/success"]
    or por_scale325["lower_t005/success"] > por_shift225["lower_t005/success"]
    or por_scale325["gap_t0055/success"] > por_shift225["gap_t0055/success"]
    or por_scale325["shoulder_t008/success"] > por_shift225["shoulder_t008/success"]
    or por_scale30["greedy/success"] > por_shift225["greedy/success"]
    or por_scale30["lower_t005/success"] > por_shift225["lower_t005/success"]
    or por_scale30["gap_t0055/success"] > por_shift225["gap_t0055/success"]
    or por_scale30["shoulder_t008/success"] > por_shift225["shoulder_t008/success"]
):
    lines.extend(
        [
            "",
    ...
    lines.extend(
        [
            "",
            "- conclusion: lowering hidden-FiLM scale below `0.35` does not improve the current `partial_shift225` surface on this fresh-root screen",
        ]
    )
