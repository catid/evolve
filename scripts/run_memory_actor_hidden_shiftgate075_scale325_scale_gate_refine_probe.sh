...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_refine_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale325_scalegate_refine_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale325_scalegate_refine_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate090.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate110.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale325_scalegate_refine_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_refine_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_refine_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_refine_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shift22_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate090",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_refine_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate090"),
        "variant": "shift22_shiftgate075_scale325_scalegate090",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate110",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_refine_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate110"),
        "variant": "shift22_shiftgate075_scale325_scalegate110",
    },
]
...
incumbent = row("por_actor_hidden_partial_shift22_shiftgate075_scale325")
scalegate090 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate090")
scalegate110 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate110")

lines = [
    "# Memory ShiftGate075 Scale325 Scale-Gate Refine Probe",
    "",
    "- hypothesis: once `shiftgate075_scale325` is alive, the best local surface may want a nearby multiplicative scale-gate power rather than exactly `1.0`",
...
for item in (por_base, por_shift22, incumbent, scalegate090, scalegate110):
    lines.append(
        ...
        f"`{item['policy/option_hidden_scale_gate_power']:.2f}` | `{item['policy/option_hidden_shift_gate_power']:.3f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )

lines.extend(
    [
        "",
        "## Deltas vs ShiftGate075 Scale325 Incumbent",
        "",
        "| Variant | Delta Greedy | Delta Lower | Delta Gap | Delta Shoulder |",
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate090` | `{scalegate090['greedy/success'] - incumbent['greedy/success']:+.4f}` | `{scalegate090['lower_t005/success'] - incumbent['lower_t005/success']:+.4f}` | `{scalegate090['gap_t0055/success'] - incumbent['gap_t0055/success']:+.4f}` | `{scalegate090['shoulder_t008/success'] - incumbent['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate110` | `{scalegate110['greedy/success'] - incumbent['greedy/success']:+.4f}` | `{scalegate110['lower_t005/success'] - incumbent['lower_t005/success']:+.4f}` | `{scalegate110['gap_t0055/success'] - incumbent['gap_t0055/success']:+.4f}` | `{scalegate110['shoulder_t008/success'] - incumbent['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)
...
interesting = any(
    ...
    and (
        item["greedy/success"] > incumbent["greedy/success"]
        or item["lower_t005/success"] > incumbent["lower_t005/success"]
        or item["gap_t0055/success"] > incumbent["gap_t0055/success"]
        or item["shoulder_t008/success"] > incumbent["shoulder_t008/success"]
    )
    for item in (scalegate090, scalegate110)
)

if interesting:
    lines.append("- conclusion: at least one nearby scale-gate power preserves nonzero greedy and improves part of the restored `shiftgate075_scale325` surface; run a 256-episode confirmation pass before treating it as real")
else:
    lines.append("- conclusion: nearby scale-gate power retuning around `shiftgate075_scale325` does not improve the restored local surface")
