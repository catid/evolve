...
ROOT="outputs/experiments/memory_actor_hidden_partial_shift_scale_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_partial_shift_scale_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_partial_shift_scale_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift25_scale30.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift25_scale325.yaml"
...
manifest = {
    ...
    "family": "memory_actor_hidden_partial_shift_scale_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_partial_shift_scale_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift25_scale30",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_partial_shift_scale_probe/memory_por_switchy_actor_hidden_partial_shift25_scale30"),
        "variant": "shift25_scale30",
    },
    {
        "label": "por_actor_hidden_partial_shift25_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_partial_shift_scale_probe/memory_por_switchy_actor_hidden_partial_shift25_scale325"),
        "variant": "shift25_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift25",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_partial_shift_scale_probe/memory_por_switchy_actor_hidden_partial_shift25"),
...
por_scale30 = row("por_actor_hidden_partial_shift25_scale30")
por_scale325 = row("por_actor_hidden_partial_shift25_scale325")
...
for item in (por_base, por_scale30, por_scale325, por_scale35):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift25_scale30` | `{por_scale30['greedy/success'] - por_scale35['greedy/success']:+.4f}` | `{por_scale30['lower_t005/success'] - por_scale35['lower_t005/success']:+.4f}` | `{por_scale30['gap_t0055/success'] - por_scale35['gap_t0055/success']:+.4f}` | `{por_scale30['shoulder_t008/success'] - por_scale35['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift25_scale325` | `{por_scale325['greedy/success'] - por_scale35['greedy/success']:+.4f}` | `{por_scale325['lower_t005/success'] - por_scale35['lower_t005/success']:+.4f}` | `{por_scale325['gap_t0055/success'] - por_scale35['gap_t0055/success']:+.4f}` | `{por_scale325['shoulder_t008/success'] - por_scale35['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
