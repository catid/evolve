...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale325_power_refine_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale325_power_refine_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale325_power_refine_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate0725_scale325.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate0775_scale325.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale325_power_refine_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_power_refine_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_power_refine_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_power_refine_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shift22_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate0725_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_power_refine_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate0725_scale325"),
        "variant": "shift22_shiftgate0725_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate0775_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_power_refine_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate0775_scale325"),
        "variant": "shift22_shiftgate0775_scale325",
    },
]
...
gate0725 = row("por_actor_hidden_partial_shift22_shiftgate0725_scale325")
gate0775 = row("por_actor_hidden_partial_shift22_shiftgate0775_scale325")

lines = [
    "# Memory ShiftGate075 Scale325 Power-Refine Probe",
    "",
    "- hypothesis: once `shiftgate075_scale325` is alive, the best local surface may want a nearby additive shift-gate power rather than exactly `0.75`",
...
for item in (por_base, por_shift22, incumbent, gate0725, gate0775):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift22_shiftgate0725_scale325` | `{gate0725['greedy/success'] - incumbent['greedy/success']:+.4f}` | `{gate0725['lower_t005/success'] - incumbent['lower_t005/success']:+.4f}` | `{gate0725['gap_t0055/success'] - incumbent['gap_t0055/success']:+.4f}` | `{gate0725['shoulder_t008/success'] - incumbent['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift22_shiftgate0775_scale325` | `{gate0775['greedy/success'] - incumbent['greedy/success']:+.4f}` | `{gate0775['lower_t005/success'] - incumbent['lower_t005/success']:+.4f}` | `{gate0775['gap_t0055/success'] - incumbent['gap_t0055/success']:+.4f}` | `{gate0775['shoulder_t008/success'] - incumbent['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)
...
interesting = any(
    ...
    for item in (gate0725, gate0775)
)

if interesting:
    lines.append("- conclusion: at least one nearby shift-gate power preserves nonzero greedy and improves part of the restored `shiftgate075_scale325` surface; run a 256-episode confirmation pass before treating it as real")
else:
    lines.append("- conclusion: nearby shift-gate power retuning around `shiftgate075_scale325` does not improve the restored local surface")
