...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale325_neg_shift_bias_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale325_neg_shift_bias_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale325_neg_shift_bias_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_shiftbiasneg01.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_shiftbiasneg02.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale325_neg_shift_bias_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_neg_shift_bias_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_neg_shift_bias_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_neg_shift_bias_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shift22_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftbiasneg01",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_neg_shift_bias_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_shiftbiasneg01"),
        "variant": "shift22_shiftgate075_scale325_shiftbiasneg01",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftbiasneg02",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_neg_shift_bias_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_shiftbiasneg02"),
        "variant": "shift22_shiftgate075_scale325_shiftbiasneg02",
    },
]
...
neg01 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftbiasneg01")
neg02 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftbiasneg02")
...
for item in (por_base, shift22, winner, neg01, neg02):
    lines.append(
        ...
        f"`{item['policy/option_hidden_shift_gate_bias_scale']:.4f}` | `{item['policy/option_hidden_gate_bias_mean']:.4f}` | "
        f"`{item['policy/option_hidden_shift_gate_bias_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | "
...
lines.extend(
    [
        ...
        "",
        f"- `shiftbiasneg01`: greedy {neg01['greedy/success'] - winner['greedy/success']:+.4f}, lower {neg01['lower_t005/success'] - winner['lower_t005/success']:+.4f}, gap {neg01['gap_t0055/success'] - winner['gap_t0055/success']:+.4f}, shoulder {neg01['shoulder_t008/success'] - winner['shoulder_t008/success']:+.4f}",
        f"- `shiftbiasneg02`: greedy {neg02['greedy/success'] - winner['greedy/success']:+.4f}, lower {neg02['lower_t005/success'] - winner['lower_t005/success']:+.4f}, gap {neg02['gap_t0055/success'] - winner['gap_t0055/success']:+.4f}, shoulder {neg02['shoulder_t008/success'] - winner['shoulder_t008/success']:+.4f}",
        "",
        "## Conclusion",
        "",
    ]
...
interesting = any(
    ...
    and (
        item["lower_t005/success"] > winner["lower_t005/success"]
        or item["gap_t0055/success"] > winner["gap_t0055/success"]
        or item["shoulder_t008/success"] > winner["shoulder_t008/success"]
        or item["greedy/success"] > winner["greedy/success"]
    )
    for item in (neg01, neg02)
)

if interesting:
    lines.append("- at least one signed negative shift-bias variant improves the current local greedy/sample surface; run a 256-episode confirmation rerun before treating it as real")
else:
    lines.append("- signed negative shift bias does not improve on `shiftgate075_scale325`; the current winner does not want learned suppression on the additive shift gate")
