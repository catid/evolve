...
ROOT="outputs/experiments/memory_actor_hidden_film_mixed_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_film_mixed_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_film_mixed_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_film.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_film_mixed50.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_film_mixed75.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_film_mixed_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_film_mixed_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_film",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_film_mixed_probe/memory_por_switchy_actor_hidden_film"),
        "variant": "duration_only",
    },
    {
        "label": "por_actor_hidden_film_mixed50",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_film_mixed_probe/memory_por_switchy_actor_hidden_film_mixed50"),
        "variant": "mix_0.50",
    },
    {
        "label": "por_actor_hidden_film_mixed75",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_film_mixed_probe/memory_por_switchy_actor_hidden_film_mixed75"),
        "variant": "mix_0.75",
    },
]
...
try:
    for run in RUNS:
        ...
        row: dict[str, Any] = {
            ...
            "policy/option_hidden_film_duration_mix": float(train_metrics.get("policy/option_hidden_film_duration_mix", 0.0)),
        }
...
por_reference = row("por_actor_hidden_film")
por_mix50 = row("por_actor_hidden_film_mixed50")
por_mix75 = row("por_actor_hidden_film_mixed75")
...
for item in (por_base, por_reference, por_mix50, por_mix75):
    lines.append(
        ...
        f"`{item['train/episode_return']:.4f}` | `{item['train/success_rate']:.4f}` | `{item['policy/option_hidden_film_gate_signal_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_film_duration_mix']:.2f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_film` | `{por_reference['greedy/success'] - por_base['greedy/success']:+.4f}` | `{por_reference['lower_t005/success'] - por_base['lower_t005/success']:+.4f}` | `{por_reference['gap_t0055/success'] - por_base['gap_t0055/success']:+.4f}` | `{por_reference['shoulder_t008/success'] - por_base['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_film_mixed50` | `{por_mix50['greedy/success'] - por_base['greedy/success']:+.4f}` | `{por_mix50['lower_t005/success'] - por_base['lower_t005/success']:+.4f}` | `{por_mix50['gap_t0055/success'] - por_base['gap_t0055/success']:+.4f}` | `{por_mix50['shoulder_t008/success'] - por_base['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_film_mixed75` | `{por_mix75['greedy/success'] - por_base['greedy/success']:+.4f}` | `{por_mix75['lower_t005/success'] - por_base['lower_t005/success']:+.4f}` | `{por_mix75['gap_t0055/success'] - por_base['gap_t0055/success']:+.4f}` | `{por_mix75['shoulder_t008/success'] - por_base['shoulder_t008/success']:+.4f}` |",
        "",
        "## Deltas vs Hidden-FiLM Reference",
        "",
        "| Variant | Delta Lower | Delta Gap | Delta Shoulder |",
        "| --- | ---: | ---: | ---: |",
        f"| `por_actor_hidden_film_mixed50` | `{por_mix50['lower_t005/success'] - por_reference['lower_t005/success']:+.4f}` | `{por_mix50['gap_t0055/success'] - por_reference['gap_t0055/success']:+.4f}` | `{por_mix50['shoulder_t008/success'] - por_reference['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_film_mixed75` | `{por_mix75['lower_t005/success'] - por_reference['lower_t005/success']:+.4f}` | `{por_mix75['gap_t0055/success'] - por_reference['gap_t0055/success']:+.4f}` | `{por_mix75['shoulder_t008/success'] - por_reference['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
