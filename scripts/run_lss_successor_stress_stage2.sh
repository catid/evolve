...
print(campaign["stage_roots"]["stage2_controls"])
...
declare -a candidates=("round6" "$BEST_CHALLENGER")
declare -a specs=()
for candidate in "${candidates[@]}"; do
  for lane in "${!BLOCK_SEEDS[@]}"; do
    ...
    for seed in "${seeds[@]}"; do
      ...
      for variant in token_dense single_expert; do
...
source .venv/bin/activate
python -m psmn_rl.analysis.lss_successor_stress stage2-report \
