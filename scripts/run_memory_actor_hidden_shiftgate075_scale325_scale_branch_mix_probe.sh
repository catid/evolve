...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scale_branch_mix_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale325_scale_branch_mix_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale325_scale_branch_mix_probe.json"
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale325_scale_branch_mix_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scale_branch_mix_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scale_branch_mix_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scale_branch_mix_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shift22_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_scalemix99",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scale_branch_mix_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_scalemix99"),
        "variant": "shift22_shiftgate075_scale325_scalemix99",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_scalemix975",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scale_branch_mix_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_scalemix975"),
        "variant": "shift22_shiftgate075_scale325_scalemix975",
    },
]
...
mix99 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_scalemix99")
mix975 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_scalemix975")

lines = [
    "# Memory ShiftGate075 Scale325 Scale-Branch Mix Probe",
    "",
    "- hypothesis: a tiny duration-to-stability mix on the scale branch may regularize the current `shiftgate075_scale325` winner without disturbing its restored shift branch",
...
for item in [por_base, shift22, winner, mix99, mix975]:
    lines.append(
        "| `{label}` | `{greedy:.4f}` | `{lower:.4f}` | `{gap:.4f}` | `{shoulder:.4f}` | `{train_return:.4f}` | `{train_success:.4f}` | `{branch_gates:.1f}` | `{scale_mix:.4f}` | `{shift_mix:.4f}` | `{scale_gate:.4f}` | `{shift_gate:.4f}` | `{scale_norm:.4f}` | `{shift_norm:.4f}` |".format(
            label=item["label"],
            ...
            branch_gates=item["policy/option_hidden_branch_gates"],
            scale_mix=item["policy/option_hidden_scale_duration_mix"],
            shift_mix=item["policy/option_hidden_shift_duration_mix"],
            scale_gate=item["policy/option_hidden_scale_gate_mean"],
            shift_gate=item["policy/option_hidden_shift_gate_mean"],
...
lines.extend(
    [
        ...
        "",
        "- `scalemix99`: greedy {g1:+.4f}, lower {l1:+.4f}, gap {gp1:+.4f}, shoulder {s1:+.4f}".format(
            g1=mix99["greedy/success"] - winner["greedy/success"],
            l1=mix99["lower_t005/success"] - winner["lower_t005/success"],
            gp1=mix99["gap_t0055/success"] - winner["gap_t0055/success"],
            s1=mix99["shoulder_t008/success"] - winner["shoulder_t008/success"],
        ),
        "- `scalemix975`: greedy {g2:+.4f}, lower {l2:+.4f}, gap {gp2:+.4f}, shoulder {s2:+.4f}".format(
            g2=mix975["greedy/success"] - winner["greedy/success"],
            l2=mix975["lower_t005/success"] - winner["lower_t005/success"],
            gp2=mix975["gap_t0055/success"] - winner["gap_t0055/success"],
            s2=mix975["shoulder_t008/success"] - winner["shoulder_t008/success"],
        ),
        "",
        "## Conclusion",
        "",
...
if survivors:
    ...
    lines.append(
        "- micro scale-branch duration mixes around `shiftgate075_scale325` do not improve the current local surface enough to justify a 256-episode confirmation pass"
    )
