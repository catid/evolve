...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_micro_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale325_scalegate_micro_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale325_scalegate_micro_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate095.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate105.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale325_scalegate_micro_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_micro_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_micro_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_micro_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shift22_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate095",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_micro_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate095"),
        "variant": "shift22_shiftgate075_scale325_scalegate095",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate105",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_scalegate_micro_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate105"),
        "variant": "shift22_shiftgate075_scale325_scalegate105",
    },
]
...
scalegate095 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate095")
scalegate105 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate105")

lines = [
    "# Memory ShiftGate075 Scale325 Scale-Gate Micro Probe",
    "",
    "- hypothesis: once `shiftgate075_scale325` is alive, the best local surface may want a very mild multiplicative scale-gate power retune around `1.0`",
...
for item in (por_base, por_shift22, incumbent, scalegate095, scalegate105):
    lines.append(
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate095` | `{scalegate095['greedy/success'] - incumbent['greedy/success']:+.4f}` | `{scalegate095['lower_t005/success'] - incumbent['lower_t005/success']:+.4f}` | `{scalegate095['gap_t0055/success'] - incumbent['gap_t0055/success']:+.4f}` | `{scalegate095['shoulder_t008/success'] - incumbent['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift22_shiftgate075_scale325_scalegate105` | `{scalegate105['greedy/success'] - incumbent['greedy/success']:+.4f}` | `{scalegate105['lower_t005/success'] - incumbent['lower_t005/success']:+.4f}` | `{scalegate105['gap_t0055/success'] - incumbent['gap_t0055/success']:+.4f}` | `{scalegate105['shoulder_t008/success'] - incumbent['shoulder_t008/success']:+.4f}` |",
        "",
    ]
)
...
interesting = any(
    ...
    for item in (scalegate095, scalegate105)
)

if interesting:
    lines.append("- conclusion: at least one micro scale-gate power retune preserves nonzero greedy and improves part of the restored `shiftgate075_scale325` surface; run a 256-episode confirmation pass before treating it as real")
else:
    lines.append("- conclusion: micro scale-gate power retuning around `shiftgate075_scale325` does not improve the restored local surface")
