...
ROOT="outputs/diagnostics/architecture_route_bias_keyed_residual_ratio_matched_probe"
REPORT_MD="outputs/reports/architecture_route_bias_keyed_residual_ratio_matched_probe.md"
REPORT_JSON="outputs/reports/architecture_route_bias_keyed_residual_ratio_matched_probe.json"
RUN_SUMMARY_MD="outputs/reports/architecture_route_bias_keyed_residual_ratio_matched_probe_run_summary.md"
RUN_SUMMARY_CSV="outputs/reports/architecture_route_bias_keyed_residual_ratio_matched_probe_run_summary.csv"
...
declare -a CONFIGS=(
  ...
  "configs/diagnostic/minigrid_doorkey_sare_phase_memory_route_bias_keyed_residual_ratio_matched_probe.yaml"
)
...
manifest = {
    ...
    "family": "architecture_route_bias_keyed_residual_ratio_matched_probe",
...
for metrics_path in sorted(root.glob("*/metrics.jsonl")):
    ...
    if "sare_phase_memory_route_bias_keyed_residual_ratio_matched" in config_text:
...
variants = {
    ...
    "sare_phase_memory_route_bias_keyed_residual_ratio_matched": summarize("sare_phase_memory_route_bias_keyed_residual_ratio_matched"),
}
report_json.write_text(json.dumps({"rows": rows, "variants": variants}, indent=2, sort_keys=True), encoding="utf-8")

lines = [
    "# Ratio-Matched Keyed-Residual Route-Bias Architecture Probe",
    "",
    "- variants: `sare_phase_memory`, `sare_phase_memory_route_bias`, `sare_phase_memory_route_bias_keyed_residual`, `sare_phase_memory_route_bias_keyed_residual_ratio_matched`",
...
lines.extend(
    [
        ...
        "## Per-Run",
        "",
        "| Variant | Seed | Eval Success | Eval Return | Train Success | Throughput | Route Bias Norm | Keyed Logits Norm | Scaled Keyed Norm | Total Logits Norm | Scale Mean | Scale Min | Scale Max | Run Dir |",
        "| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |",
    ]
)
for row in rows:
