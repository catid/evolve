...
ROOT="outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_floor_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_shiftgate075_scale325_shift_floor_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_shiftgate075_scale325_shift_floor_probe.json"
...
manifest = {
    ...
    "family": "memory_actor_hidden_shiftgate075_scale325_shift_floor_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_floor_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift22",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_floor_probe/memory_por_switchy_actor_hidden_partial_shift22"),
        "variant": "partial_shift22",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_floor_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325"),
        "variant": "shift22_shiftgate075_scale325",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftfloor20",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_floor_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_shiftfloor20"),
        "variant": "shift22_shiftgate075_scale325_shiftfloor20",
    },
    {
        "label": "por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftfloor21",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_shiftgate075_scale325_shift_floor_probe/memory_por_switchy_actor_hidden_partial_shift22_shiftgate075_scale325_shiftfloor21"),
        "variant": "shift22_shiftgate075_scale325_shiftfloor21",
    },
]
...
floor20 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftfloor20")
floor21 = row("por_actor_hidden_partial_shift22_shiftgate075_scale325_shiftfloor21")

lines = [
    "# Memory ShiftGate075 Scale325 Shift-Floor Probe",
    "",
    "- hypothesis: once `shiftgate075_scale325` is alive, a mild adaptive shift floor may stabilize low-gate states without sacrificing the new greedy plateau",
    ...
    "## Aggregate",
    "",
    "| Label | Greedy | Lower t0.05 | Gap t0.055 | Shoulder t0.08 | Greedy Margin | Gap Margin | Shoulder Margin | Train Return | Train Success | Gate Signal | Gate Mean | Adaptive Shift Floor | Shift Floor | Shift Floor Power | Adaptive Shift Weight Mean | Scale Norm | Shift Norm |",
    "| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |",
]

for item in [por_base, shift22, winner, floor20, floor21]:
    lines.append(
        "| `{label}` | `{greedy:.4f}` | `{lower:.4f}` | `{gap:.4f}` | `{shoulder:.4f}` | `{greedy_margin:.4f}` | `{gap_margin:.4f}` | `{shoulder_margin:.4f}` | `{train_return:.4f}` | `{train_success:.4f}` | `{gate_signal:.4f}` | `{gate_mean:.4f}` | `{adaptive_shift_floor:.0f}` | `{shift_floor:.4f}` | `{shift_floor_power:.2f}` | `{adaptive_shift_weight_mean:.4f}` | `{scale_norm:.4f}` | `{shift_norm:.4f}` |".format(
            label=item["label"],
            ...
            adaptive_shift_floor=item["policy/option_hidden_adaptive_shift_floor"],
...
lines.extend(
    [
        ...
        "",
        "- `shiftfloor20`: greedy {g1:+.4f}, lower {l1:+.4f}, gap {gp1:+.4f}, shoulder {s1:+.4f}".format(
            g1=floor20["greedy/success"] - winner["greedy/success"],
            l1=floor20["lower_t005/success"] - winner["lower_t005/success"],
            gp1=floor20["gap_t0055/success"] - winner["gap_t0055/success"],
            s1=floor20["shoulder_t008/success"] - winner["shoulder_t008/success"],
        ),
        "- `shiftfloor21`: greedy {g2:+.4f}, lower {l2:+.4f}, gap {gp2:+.4f}, shoulder {s2:+.4f}".format(
            g2=floor21["greedy/success"] - winner["greedy/success"],
            l2=floor21["lower_t005/success"] - winner["lower_t005/success"],
            gp2=floor21["gap_t0055/success"] - winner["gap_t0055/success"],
            s2=floor21["shoulder_t008/success"] - winner["shoulder_t008/success"],
        ),
        "",
        "## Conclusion",
        "",
...
if survivors:
    ...
    lines.append(
        "- mild adaptive shift floors around `shiftgate075_scale325` do not improve the current local surface enough to justify a 256-episode confirmation pass"
    )
