...
ROOT="outputs/experiments/memory_actor_hidden_scale_weight_followup_probe"
REPORT_MD="outputs/reports/memory_actor_hidden_scale_weight_followup_probe.md"
REPORT_JSON="outputs/reports/memory_actor_hidden_scale_weight_followup_probe.json"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225_scaleweight90.yaml"
  "configs/experiments/minigrid_memory_por_switchy_actor_hidden_partial_shift225_scaleweight95.yaml"
)
...
manifest = {
    ...
    "family": "memory_actor_hidden_scale_weight_followup_probe",
    "task": "Memory",
    "gpu": gpu,
...
RUNS = [
    {
        "label": "por_base",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_weight_followup_probe/memory_por_switchy_rerun"),
        "variant": "none",
    },
    {
        "label": "por_actor_hidden_partial_shift225",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_weight_followup_probe/memory_por_switchy_actor_hidden_partial_shift225"),
        "variant": "scale_weight_1.00",
    },
    {
        "label": "por_actor_hidden_partial_shift225_scaleweight90",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_weight_followup_probe/memory_por_switchy_actor_hidden_partial_shift225_scaleweight90"),
        "variant": "scale_weight_0.90",
    },
    {
        "label": "por_actor_hidden_partial_shift225_scaleweight95",
        "run_dir": Path("outputs/experiments/memory_actor_hidden_scale_weight_followup_probe/memory_por_switchy_actor_hidden_partial_shift225_scaleweight95"),
        "variant": "scale_weight_0.95",
    },
]
...
try:
    for run in RUNS:
        ...
        row: dict[str, Any] = {
            ...
            "policy/option_hidden_film_scale_weight": float(train_metrics.get("policy/option_hidden_film_scale_weight", 1.0)),
...
por_scale100 = row("por_actor_hidden_partial_shift225")
por_scale90 = row("por_actor_hidden_partial_shift225_scaleweight90")
por_scale95 = row("por_actor_hidden_partial_shift225_scaleweight95")
...
for item in (por_base, por_scale100, por_scale90, por_scale95):
    lines.append(
        ...
        f"`{item['train/episode_return']:.4f}` | `{item['train/success_rate']:.4f}` | `{item['policy/option_hidden_film_gate_signal_mean']:.4f}` | `{item['policy/option_hidden_film_gate_mean']:.4f}` | `{item['policy/option_hidden_film_scale_weight']:.2f}` | `{item['policy/option_hidden_film_shift_weight']:.3f}` | `{item['policy/option_hidden_film_scale_norm']:.4f}` | `{item['policy/option_hidden_film_shift_norm']:.4f}` |"
    )
...
lines.extend(
    [
        ...
        "| --- | ---: | ---: | ---: | ---: |",
        f"| `por_actor_hidden_partial_shift225_scaleweight90` | `{por_scale90['greedy/success'] - por_scale100['greedy/success']:+.4f}` | `{por_scale90['lower_t005/success'] - por_scale100['lower_t005/success']:+.4f}` | `{por_scale90['gap_t0055/success'] - por_scale100['gap_t0055/success']:+.4f}` | `{por_scale90['shoulder_t008/success'] - por_scale100['shoulder_t008/success']:+.4f}` |",
        f"| `por_actor_hidden_partial_shift225_scaleweight95` | `{por_scale95['greedy/success'] - por_scale100['greedy/success']:+.4f}` | `{por_scale95['lower_t005/success'] - por_scale100['lower_t005/success']:+.4f}` | `{por_scale95['gap_t0055/success'] - por_scale100['gap_t0055/success']:+.4f}` | `{por_scale95['shoulder_t008/success'] - por_scale100['shoulder_t008/success']:+.4f}` |",
        "",
        "## Interpretation",
        "",
