...
- The current active DoorKey benchmark now sits inside the same teacher-guided `KL` learner-state family:
  ...
  - operational gate result: `PASS: thaw consideration allowed`
  - current benchmark result: `benchmark/frontier state needs narrowing`
  - current state repair: `round6 remains the active benchmark and the state is now coherent and narrowed`
...
- The later 80-run next-mega saturation campaign then overturned the stronger internal reading without displacing `round6`. It spent eighty substantive challengers split `40/40` fruitful versus exploratory, advanced no Stage 1 survivor, left the holdout picture at `0.8320` versus `0.8333` for both matched controls, preserved a `1.0000` healthy-family mean, kept the route and stability passes, and again left KeyCorridor clearly negative. The live state was then repaired by snapshotting the narrowed ledger state and sealing a separate current gate-reference pack so the archived frozen pack could remain untouched as provenance. See [next_mega_portfolio_stage1_screening_fruitful.md](outputs/reports/next_mega_portfolio_stage1_screening_fruitful.md), [next_mega_portfolio_stage1_screening_exploratory.md](outputs/reports/next_mega_portfolio_stage1_screening_exploratory.md), [next_mega_portfolio_stage4_holdout.md](outputs/reports/next_mega_portfolio_stage4_holdout.md), [next_mega_portfolio_stage5_antiregression.md](outputs/reports/next_mega_portfolio_stage5_antiregression.md), [next_mega_portfolio_stage6_route_validation.md](outputs/reports/next_mega_portfolio_stage6_route_validation.md), [next_mega_portfolio_stage7_stability.md](outputs/reports/next_mega_portfolio_stage7_stability.md), [next_mega_portfolio_stage8_exploratory_transfer.md](outputs/reports/next_mega_portfolio_stage8_exploratory_transfer.md), [next_mega_portfolio_decision_memo.md](outputs/reports/next_mega_portfolio_decision_memo.md), [next_round_state_reconciliation.md](outputs/reports/next_round_state_reconciliation.md), and [next_round_gate_repair.md](outputs/reports/next_round_gate_repair.md).
...
- the repaired live gate now runs against `outputs/reports/round6_current_benchmark_pack.json`, while the archived frozen pack remains untouched for provenance
- the frozen operational frontier now starts from `round7`, keeps `round10` as the replay-validated alternate, and is guarded by [portfolio_frontier_contract.md](outputs/reports/portfolio_frontier_contract.md), [portfolio_frontier_schedule.md](outputs/reports/portfolio_frontier_schedule.md), [portfolio_frontier_kit.md](outputs/reports/portfolio_frontier_kit.md), [portfolio_seed_pack.md](outputs/reports/portfolio_seed_pack.md), [portfolio_frontier_doctor.md](outputs/reports/portfolio_frontier_doctor.md), [portfolio_frontier_guard_workflow_contract.md](outputs/reports/portfolio_frontier_guard_workflow_contract.md), [portfolio_active_state_doctor.md](outputs/reports/portfolio_active_state_doctor.md), [portfolio_operational_state.md](outputs/reports/portfolio_operational_state.md), [portfolio_seed_pack_doctor.md](outputs/reports/portfolio_seed_pack_doctor.md), and [portfolio_frontier_guard_report.md](outputs/reports/portfolio_frontier_guard_report.md)
