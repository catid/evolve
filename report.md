...
- active benchmark pack: [expansion_mega_program_candidate_pack.json](outputs/reports/expansion_mega_program_candidate_pack.json)
- expansion program gate result: [expansion_mega_program_gate_report.md](outputs/reports/expansion_mega_program_gate_report.md)
- expansion program decision: [expansion_mega_program_decision_memo.md](outputs/reports/expansion_mega_program_decision_memo.md)
