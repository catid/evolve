...
def test_all_variants_forward_shapes() -> None:
    ...
    variants = ["flat_dense", "token_dense", "token_gru", "single_expert", "sare", "sare_phase_memory", "sare_phase_memory_gated", "sare_phase_memory_route_bias", "sare_phase_memory_route_bias_keyed", "sare_phase_memory_route_bias_keyed_residual", "sare_phase_memory_route_bias_keyed_residual_per_expert_scale", "sare_phase_memory_route_bias_keyed_residual_learned_scale", "sare_phase_memory_route_bias_keyed_residual_topk_masked", "sare_phase_memory_route_bias_keyed_residual_postact", "sare_phase_memory_route_bias_keyed_residual_centered", "sare_phase_memory_route_bias_keyed_residual_boosted", "sare_phase_memory_route_bias_keyed_residual_entropy_gate", "sare_phase_memory_route_bias_contextual", "sare_phase_memory_route_bias_scale_gate", "sare_phase_memory_route_bias_normalized", "sare_phase_memory_route_bias_layernorm", "sare_phase_memory_route_bias_gated", "sare_phase_memory_route_bias_dual", "treg_h", "srw", "por"]
