...
def _write_single_run_summary(
    ...
    summary = {
        ...
        "teacher_confidence_floor": spec.student.teacher_confidence_floor,
        "teacher_confidence_ceiling": spec.student.teacher_confidence_ceiling,
    ...
    lines = [
        ...
        f"- teacher_confidence_floor: `{spec.student.teacher_confidence_floor}`",
        f"- teacher_confidence_ceiling: `{spec.student.teacher_confidence_ceiling}`",
