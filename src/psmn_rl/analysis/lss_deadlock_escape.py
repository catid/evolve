...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Detector-triggered deadlock-escape helpers around the active round6 benchmark")
    ...
    for command in (
        ...
        if command == "run-task":
            ...
            item.add_argument("--device", default="auto")
        elif command in {"subgroup-detector"}:
